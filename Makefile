...
pkgdatadir = $(datadir)/exabayes
pkgincludedir = $(includedir)/exabayes
pkglibdir = $(libdir)/exabayes
pkglibexecdir = $(libexecdir)/exabayes
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = yggdrasil$(EXEEXT) sdsf$(EXEEXT) postProcParam$(EXEEXT) \
	credibleSet$(EXEEXT) extractBips$(EXEEXT) consense$(EXEEXT) \
	parser$(EXEEXT) $(am__EXEEXT_1) $(am__EXEEXT_2)

# configure examl/pll specific stuff 
#am__append_1 = exabayes 
#am__append_2 = libcommmpi.a
#am__append_3 = exatest
#am__append_4 = -D_WITH_MPI	
subdir = .
...
#am__EXEEXT_2 = exatest$(EXEEXT)
am__installdirs = "$(DESTDIR)$(bindir)"
PROGRAMS = $(bin_PROGRAMS)
am_consense_OBJECTS = ./src/apps/consense-consense.$(OBJEXT)
consense_OBJECTS = $(am_consense_OBJECTS)
consense_DEPENDENCIES = $(seqlibs)
consense_LINK = $(CXXLD) $(consense_CXXFLAGS) $(CXXFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
am_credibleSet_OBJECTS = ./src/apps/credibleSet-credibleSet.$(OBJEXT)
credibleSet_OBJECTS = $(am_credibleSet_OBJECTS)
credibleSet_DEPENDENCIES = $(seqlibs)
credibleSet_LINK = $(CXXLD) $(credibleSet_CXXFLAGS) $(CXXFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
am_exabayes_OBJECTS = ./src/apps/exabayes-exabayes.$(OBJEXT)
exabayes_OBJECTS = $(am_exabayes_OBJECTS)
am__DEPENDENCIES_1 =
exabayes_DEPENDENCIES = $(paralibs) $(am__DEPENDENCIES_1)
exabayes_LINK = $(CXXLD) $(exabayes_CXXFLAGS) $(CXXFLAGS) \
	$(exabayes_LDFLAGS) $(LDFLAGS) -o $@
am_exatest_OBJECTS = ./tests/exatest-exatest.$(OBJEXT)
exatest_OBJECTS = $(am_exatest_OBJECTS)
exatest_DEPENDENCIES = $(seqlibs)
exatest_LINK = $(CXXLD) $(exatest_CXXFLAGS) $(CXXFLAGS) \
	$(exatest_LDFLAGS) $(LDFLAGS) -o $@
am_extractBips_OBJECTS = ./src/apps/extractBips-extractBips.$(OBJEXT)
extractBips_OBJECTS = $(am_extractBips_OBJECTS)
extractBips_DEPENDENCIES = $(seqlibs)
extractBips_LINK = $(CXXLD) $(extractBips_CXXFLAGS) $(CXXFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
am_parser_OBJECTS = ./src/apps/parser-parser.$(OBJEXT)
parser_OBJECTS = $(am_parser_OBJECTS)
parser_DEPENDENCIES = $(seqlibs)
parser_LINK = $(CXXLD) $(parser_CXXFLAGS) $(CXXFLAGS) $(AM_LDFLAGS) \
	$(LDFLAGS) -o $@
am_postProcParam_OBJECTS =  \
	./src/apps/postProcParam-postProcParam.$(OBJEXT)
postProcParam_OBJECTS = $(am_postProcParam_OBJECTS)
postProcParam_DEPENDENCIES = $(seqlibs)
postProcParam_LINK = $(CXXLD) $(postProcParam_CXXFLAGS) $(CXXFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
am_sdsf_OBJECTS = ./src/apps/sdsf-sdsf.$(OBJEXT)
sdsf_OBJECTS = $(am_sdsf_OBJECTS)
sdsf_DEPENDENCIES = libncl.a libbayes.a libpll.a libncl.a
sdsf_LINK = $(CXXLD) $(sdsf_CXXFLAGS) $(CXXFLAGS) $(AM_LDFLAGS) \
	$(LDFLAGS) -o $@
am_yggdrasil_OBJECTS = ./src/apps/yggdrasil-exabayes.$(OBJEXT)
yggdrasil_OBJECTS = $(am_yggdrasil_OBJECTS)
yggdrasil_DEPENDENCIES = $(seqlibs)
yggdrasil_LINK = $(CXXLD) $(yggdrasil_CXXFLAGS) $(CXXFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CXXLD_1 = 
SOURCES = $(libbayes_a_SOURCES) $(libcommdummy_a_SOURCES) \
	$(libcommmpi_a_SOURCES) $(liblcfit_a_SOURCES) \
	$(libncl_a_SOURCES) $(libpll_a_SOURCES) $(consense_SOURCES) \
	$(credibleSet_SOURCES) $(exabayes_SOURCES) $(exatest_SOURCES) \
	$(extractBips_SOURCES) $(parser_SOURCES) \
	$(postProcParam_SOURCES) $(sdsf_SOURCES) $(yggdrasil_SOURCES)
DIST_SOURCES = $(libbayes_a_SOURCES) $(libcommdummy_a_SOURCES) \
	$(libcommmpi_a_SOURCES) $(liblcfit_a_SOURCES) \
	$(libncl_a_SOURCES) $(libpll_a_SOURCES) $(consense_SOURCES) \
	$(credibleSet_SOURCES) $(exabayes_SOURCES) $(exatest_SOURCES) \
	$(extractBips_SOURCES) $(parser_SOURCES) \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/src-helper.am \
	$(srcdir)/src.am $(top_srcdir)/src/config.h.in COPYING compile \
...
ACLOCAL = ${SHELL} /Users/bclaywel/workspace/exabayes/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /Users/bclaywel/workspace/exabayes/missing autoconf
AUTOHEADER = ${SHELL} /Users/bclaywel/workspace/exabayes/missing autoheader
AUTOMAKE = ${SHELL} /Users/bclaywel/workspace/exabayes/missing automake-1.15
AWK = awk
CC = gcc
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lnlopt -lgsl -lgslcblas -lm 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/bclaywel/workspace/exabayes/missing makeinfo
...
OBJEXT = o
PACKAGE = exabayes
PACKAGE_BUGREPORT = exabayes-at-googlegroups-dot-com
PACKAGE_NAME = exabayes
PACKAGE_STRING = exabayes 1.3.1
PACKAGE_TARNAME = exabayes
PACKAGE_URL = 
...
STRIP = 
VERSION = 1.3.1
abs_builddir = /Users/bclaywel/workspace/exabayes
abs_srcdir = /Users/bclaywel/workspace/exabayes
abs_top_builddir = /Users/bclaywel/workspace/exabayes
abs_top_srcdir = /Users/bclaywel/workspace/exabayes
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /Users/bclaywel/workspace/exabayes/install-sh
...
pdfdir = ${docdir}
prefix = /Users/bclaywel/Applications/exabayes
...
noinst_LIBRARIES = libbayes.a libncl.a libcommdummy.a libpll.a \
	liblcfit.a $(am__append_2)
...
exatest_CXXFLAGS = $(AM_CXXFLAGS) -O3 $(VECTOR_FLAGS) \
	$(BAYES_INCLUDES) -D_IS_YGG $(am__append_4)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/src-helper.am $(srcdir)/src.am $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/src-helper.am $(srcdir)/src.am $(am__empty):
...
./src/parser/libbayes_a-PhylipParser.$(OBJEXT):  \
	src/parser/$(am__dirstamp) \
	src/parser/$(DEPDIR)/$(am__dirstamp)
src/tree-parse/$(am__dirstamp):
	@$(MKDIR_P) ./src/tree-parse
	@: > src/tree-parse/$(am__dirstamp)
src/tree-parse/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ./src/tree-parse/$(DEPDIR)
	@: > src/tree-parse/$(DEPDIR)/$(am__dirstamp)
./src/tree-parse/libbayes_a-BasicTreeReader.$(OBJEXT):  \
	src/tree-parse/$(am__dirstamp) \
	src/tree-parse/$(DEPDIR)/$(am__dirstamp)
...
src/mcmc/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ./src/mcmc/$(DEPDIR)
	@: > src/mcmc/$(DEPDIR)/$(am__dirstamp)
./src/mcmc/libbayes_a-Chain.$(OBJEXT): src/mcmc/$(am__dirstamp) \
	src/mcmc/$(DEPDIR)/$(am__dirstamp)
./src/mcmc/libbayes_a-CoupledChains.$(OBJEXT):  \
...
libbayes.a: $(libbayes_a_OBJECTS) $(libbayes_a_DEPENDENCIES) $(EXTRA_libbayes_a_DEPENDENCIES) 
	$(AM_V_at)-rm -f libbayes.a
	$(AM_V_AR)$(libbayes_a_AR) libbayes.a $(libbayes_a_OBJECTS) $(libbayes_a_LIBADD)
	$(AM_V_at)$(RANLIB) libbayes.a
src/comm/$(am__dirstamp):
	@$(MKDIR_P) ./src/comm
	@: > src/comm/$(am__dirstamp)
...
src/comm/dummy/$(am__dirstamp):
	...
	@: > src/comm/dummy/$(am__dirstamp)
src/comm/dummy/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ./src/comm/dummy/$(DEPDIR)
	@: > src/comm/dummy/$(DEPDIR)/$(am__dirstamp)
./src/comm/dummy/libcommdummy_a-CommRequestImpl.$(OBJEXT):  \
	src/comm/dummy/$(am__dirstamp) \
	src/comm/dummy/$(DEPDIR)/$(am__dirstamp)
...
libcommdummy.a: $(libcommdummy_a_OBJECTS) $(libcommdummy_a_DEPENDENCIES) $(EXTRA_libcommdummy_a_DEPENDENCIES) 
...
libcommmpi.a: $(libcommmpi_a_OBJECTS) $(libcommmpi_a_DEPENDENCIES) $(EXTRA_libcommmpi_a_DEPENDENCIES) 
	$(AM_V_at)-rm -f libcommmpi.a
	$(AM_V_AR)$(libcommmpi_a_AR) libcommmpi.a $(libcommmpi_a_OBJECTS) $(libcommmpi_a_LIBADD)
	$(AM_V_at)$(RANLIB) libcommmpi.a
lib/lcfit/lcfit_src/$(am__dirstamp):
	@$(MKDIR_P) ./lib/lcfit/lcfit_src
	@: > lib/lcfit/lcfit_src/$(am__dirstamp)
...
liblcfit.a: $(liblcfit_a_OBJECTS) $(liblcfit_a_DEPENDENCIES) $(EXTRA_liblcfit_a_DEPENDENCIES) 
	$(AM_V_at)-rm -f liblcfit.a
	$(AM_V_AR)$(liblcfit_a_AR) liblcfit.a $(liblcfit_a_OBJECTS) $(liblcfit_a_LIBADD)
	$(AM_V_at)$(RANLIB) liblcfit.a
lib/ncl-2.1.18/ncl/$(am__dirstamp):
	@$(MKDIR_P) ./lib/ncl-2.1.18/ncl
	@: > lib/ncl-2.1.18/ncl/$(am__dirstamp)
...
libncl.a: $(libncl_a_OBJECTS) $(libncl_a_DEPENDENCIES) $(EXTRA_libncl_a_DEPENDENCIES) 
	$(AM_V_at)-rm -f libncl.a
	$(AM_V_AR)$(libncl_a_AR) libncl.a $(libncl_a_OBJECTS) $(libncl_a_LIBADD)
	$(AM_V_at)$(RANLIB) libncl.a
lib/pll/$(am__dirstamp):
	@$(MKDIR_P) ./lib/pll
	@: > lib/pll/$(am__dirstamp)
...
libpll.a: $(libpll_a_OBJECTS) $(libpll_a_DEPENDENCIES) $(EXTRA_libpll_a_DEPENDENCIES) 
	$(AM_V_at)-rm -f libpll.a
	$(AM_V_AR)$(libpll_a_AR) libpll.a $(libpll_a_OBJECTS) $(libpll_a_LIBADD)
	$(AM_V_at)$(RANLIB) libpll.a
...
src/apps/$(DEPDIR)/$(am__dirstamp):
	...
	@: > src/apps/$(DEPDIR)/$(am__dirstamp)
./src/apps/consense-consense.$(OBJEXT): src/apps/$(am__dirstamp) \
	src/apps/$(DEPDIR)/$(am__dirstamp)

consense$(EXEEXT): $(consense_OBJECTS) $(consense_DEPENDENCIES) $(EXTRA_consense_DEPENDENCIES) 
	@rm -f consense$(EXEEXT)
	$(AM_V_CXXLD)$(consense_LINK) $(consense_OBJECTS) $(consense_LDADD) $(LIBS)
./src/apps/credibleSet-credibleSet.$(OBJEXT):  \
	src/apps/$(am__dirstamp) src/apps/$(DEPDIR)/$(am__dirstamp)

credibleSet$(EXEEXT): $(credibleSet_OBJECTS) $(credibleSet_DEPENDENCIES) $(EXTRA_credibleSet_DEPENDENCIES) 
	@rm -f credibleSet$(EXEEXT)
	$(AM_V_CXXLD)$(credibleSet_LINK) $(credibleSet_OBJECTS) $(credibleSet_LDADD) $(LIBS)
./src/apps/exabayes-exabayes.$(OBJEXT): src/apps/$(am__dirstamp) \
	src/apps/$(DEPDIR)/$(am__dirstamp)

exabayes$(EXEEXT): $(exabayes_OBJECTS) $(exabayes_DEPENDENCIES) $(EXTRA_exabayes_DEPENDENCIES) 
	@rm -f exabayes$(EXEEXT)
	$(AM_V_CXXLD)$(exabayes_LINK) $(exabayes_OBJECTS) $(exabayes_LDADD) $(LIBS)
tests/$(am__dirstamp):
	@$(MKDIR_P) ./tests
	@: > tests/$(am__dirstamp)
tests/$(DEPDIR)/$(am__dirstamp):
	...
	@: > tests/$(DEPDIR)/$(am__dirstamp)
./tests/exatest-exatest.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)

exatest$(EXEEXT): $(exatest_OBJECTS) $(exatest_DEPENDENCIES) $(EXTRA_exatest_DEPENDENCIES) 
	@rm -f exatest$(EXEEXT)
	$(AM_V_CXXLD)$(exatest_LINK) $(exatest_OBJECTS) $(exatest_LDADD) $(LIBS)
./src/apps/extractBips-extractBips.$(OBJEXT):  \
	src/apps/$(am__dirstamp) src/apps/$(DEPDIR)/$(am__dirstamp)

extractBips$(EXEEXT): $(extractBips_OBJECTS) $(extractBips_DEPENDENCIES) $(EXTRA_extractBips_DEPENDENCIES) 
	@rm -f extractBips$(EXEEXT)
	$(AM_V_CXXLD)$(extractBips_LINK) $(extractBips_OBJECTS) $(extractBips_LDADD) $(LIBS)
./src/apps/parser-parser.$(OBJEXT): src/apps/$(am__dirstamp) \
	src/apps/$(DEPDIR)/$(am__dirstamp)

parser$(EXEEXT): $(parser_OBJECTS) $(parser_DEPENDENCIES) $(EXTRA_parser_DEPENDENCIES) 
	@rm -f parser$(EXEEXT)
	$(AM_V_CXXLD)$(parser_LINK) $(parser_OBJECTS) $(parser_LDADD) $(LIBS)
./src/apps/postProcParam-postProcParam.$(OBJEXT):  \
	src/apps/$(am__dirstamp) src/apps/$(DEPDIR)/$(am__dirstamp)

postProcParam$(EXEEXT): $(postProcParam_OBJECTS) $(postProcParam_DEPENDENCIES) $(EXTRA_postProcParam_DEPENDENCIES) 
	@rm -f postProcParam$(EXEEXT)
	$(AM_V_CXXLD)$(postProcParam_LINK) $(postProcParam_OBJECTS) $(postProcParam_LDADD) $(LIBS)
./src/apps/sdsf-sdsf.$(OBJEXT): src/apps/$(am__dirstamp) \
	src/apps/$(DEPDIR)/$(am__dirstamp)

sdsf$(EXEEXT): $(sdsf_OBJECTS) $(sdsf_DEPENDENCIES) $(EXTRA_sdsf_DEPENDENCIES) 
	@rm -f sdsf$(EXEEXT)
	$(AM_V_CXXLD)$(sdsf_LINK) $(sdsf_OBJECTS) $(sdsf_LDADD) $(LIBS)
./src/apps/yggdrasil-exabayes.$(OBJEXT): src/apps/$(am__dirstamp) \
	src/apps/$(DEPDIR)/$(am__dirstamp)

yggdrasil$(EXEEXT): $(yggdrasil_OBJECTS) $(yggdrasil_DEPENDENCIES) $(EXTRA_yggdrasil_DEPENDENCIES) 
	@rm -f yggdrasil$(EXEEXT)
	$(AM_V_CXXLD)$(yggdrasil_LINK) $(yggdrasil_OBJECTS) $(yggdrasil_LDADD) $(LIBS)

mostlyclean-compile:
	-rm -f *.$(OBJEXT)
	-rm -f ./lib/lcfit/lcfit_src/*.$(OBJEXT)
	-rm -f ./lib/ncl-2.1.18/ncl/*.$(OBJEXT)
	-rm -f ./lib/pll/*.$(OBJEXT)
	-rm -f ./src/*.$(OBJEXT)
	-rm -f ./src/apps/*.$(OBJEXT)
	-rm -f ./src/comm/*.$(OBJEXT)
	-rm -f ./src/comm/dummy/*.$(OBJEXT)
	-rm -f ./src/comm/mpi/*.$(OBJEXT)
	-rm -f ./src/comm/threads/*.$(OBJEXT)
	-rm -f ./src/config/*.$(OBJEXT)
	-rm -f ./src/contrib/*.$(OBJEXT)
	-rm -f ./src/data-struct/*.$(OBJEXT)
	-rm -f ./src/eval/*.$(OBJEXT)
	-rm -f ./src/file/*.$(OBJEXT)
	-rm -f ./src/math/*.$(OBJEXT)
	-rm -f ./src/mcmc/*.$(OBJEXT)
	-rm -f ./src/model/*.$(OBJEXT)
	-rm -f ./src/parameters/*.$(OBJEXT)
	-rm -f ./src/parser/*.$(OBJEXT)
	-rm -f ./src/priors/*.$(OBJEXT)
	-rm -f ./src/proposals/*.$(OBJEXT)
	-rm -f ./src/proposers/*.$(OBJEXT)
	-rm -f ./src/system/*.$(OBJEXT)
	-rm -f ./src/tree-parse/*.$(OBJEXT)
	-rm -f ./tests/*.$(OBJEXT)
...
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscharactersblock.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscxxdiscretematrix.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsdatablock.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsdistancesblock.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsexception.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsmultiformat.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxspublicblocks.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsreader.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxssetreader.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsstring.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxaassociationblock.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstoken.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstreesblock.Po
include ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsunalignedblock.Po
include ./lib/pll/$(DEPDIR)/libpll_a-alignment.Po
include ./lib/pll/$(DEPDIR)/libpll_a-bipartitionList.Po
include ./lib/pll/$(DEPDIR)/libpll_a-evaluateGenericSpecial.Po
include ./lib/pll/$(DEPDIR)/libpll_a-evaluatePartialGenericSpecial.Po
include ./lib/pll/$(DEPDIR)/libpll_a-fastDNAparsimony.Po
include ./lib/pll/$(DEPDIR)/libpll_a-hash.Po
include ./lib/pll/$(DEPDIR)/libpll_a-lexer.Po
include ./lib/pll/$(DEPDIR)/libpll_a-makenewzGenericSpecial.Po
include ./lib/pll/$(DEPDIR)/libpll_a-models.Po
include ./lib/pll/$(DEPDIR)/libpll_a-newick.Po
include ./lib/pll/$(DEPDIR)/libpll_a-newviewGenericSpecial.Po
include ./lib/pll/$(DEPDIR)/libpll_a-optimizeModel.Po
include ./lib/pll/$(DEPDIR)/libpll_a-parsePartition.Po
include ./lib/pll/$(DEPDIR)/libpll_a-queue.Po
include ./lib/pll/$(DEPDIR)/libpll_a-randomTree.Po
include ./lib/pll/$(DEPDIR)/libpll_a-recom.Po
include ./lib/pll/$(DEPDIR)/libpll_a-restartHashTable.Po
include ./lib/pll/$(DEPDIR)/libpll_a-searchAlgo.Po
include ./lib/pll/$(DEPDIR)/libpll_a-ssort.Po
include ./lib/pll/$(DEPDIR)/libpll_a-stack.Po
include ./lib/pll/$(DEPDIR)/libpll_a-topologies.Po
include ./lib/pll/$(DEPDIR)/libpll_a-trash.Po
include ./lib/pll/$(DEPDIR)/libpll_a-treeIO.Po
include ./lib/pll/$(DEPDIR)/libpll_a-utils.Po
include ./src/$(DEPDIR)/libbayes_a-AdHocIntegrator.Po
include ./src/$(DEPDIR)/libbayes_a-BranchLengthOptimizer.Po
include ./src/$(DEPDIR)/libbayes_a-ComplexTuner.Po
include ./src/$(DEPDIR)/libbayes_a-GammaProposer.Po
include ./src/$(DEPDIR)/libbayes_a-GibbsProposal.Po
include ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Po
include ./src/$(DEPDIR)/libbayes_a-PrescoredDrawer.Po
include ./src/$(DEPDIR)/libbayes_a-TreeIntegrator.Po
include ./src/$(DEPDIR)/libbayes_a-TreePrinter.Po
include ./src/$(DEPDIR)/libbayes_a-TreeRandomizer.Po
include ./src/$(DEPDIR)/libbayes_a-TreeTraverser.Po
include ./src/$(DEPDIR)/libbayes_a-WeibullProposer.Po
include ./src/$(DEPDIR)/libpll_a-avxConditional.Po
include ./src/apps/$(DEPDIR)/consense-consense.Po
include ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Po
include ./src/apps/$(DEPDIR)/exabayes-exabayes.Po
include ./src/apps/$(DEPDIR)/extractBips-extractBips.Po
include ./src/apps/$(DEPDIR)/parser-parser.Po
include ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Po
include ./src/apps/$(DEPDIR)/sdsf-sdsf.Po
include ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-CommRequest.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-Communicator.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-IncompleteMesh.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-LocalComm.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-ParallelSetup.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-PendingSwap.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-RemoteComm.Po
include ./src/comm/$(DEPDIR)/libcommdummy_a-SwapElem.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-CommRequest.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-Communicator.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-IncompleteMesh.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-LocalComm.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-ParallelSetup.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-PendingSwap.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-RemoteComm.Po
include ./src/comm/$(DEPDIR)/libcommmpi_a-SwapElem.Po
include ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-CommRequestImpl.Po
include ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Po
include ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Po
include ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-CommRequestImpl.Po
include ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-MpiType.Po
include ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-PendingSwapImpl.Po
include ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Po
include ./src/comm/threads/$(DEPDIR)/libcommdummy_a-MessageQueue.Po
include ./src/comm/threads/$(DEPDIR)/libcommdummy_a-MessageQueueSingle.Po
include ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Po
include ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueue.Po
include ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueueSingle.Po
include ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Po
include ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Po
include ./src/config/$(DEPDIR)/libbayes_a-BlockPrior.Po
include ./src/config/$(DEPDIR)/libbayes_a-BlockProposalConfig.Po
include ./src/config/$(DEPDIR)/libbayes_a-BlockRunParameters.Po
include ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Po
include ./src/config/$(DEPDIR)/libbayes_a-ExaBlock.Po
include ./src/config/$(DEPDIR)/libbayes_a-MemoryMode.Po
include ./src/contrib/$(DEPDIR)/libbayes_a-BipartitionExtractor.Po
include ./src/contrib/$(DEPDIR)/libbayes_a-ConsensusTree.Po
include ./src/contrib/$(DEPDIR)/libbayes_a-CredibleSet.Po
include ./src/contrib/$(DEPDIR)/libbayes_a-SplitFreqAssessor.Po
include ./src/data-struct/$(DEPDIR)/libbayes_a-Bipartition.Po
include ./src/data-struct/$(DEPDIR)/libbayes_a-BipartitionHash.Po
include ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Po
include ./src/eval/$(DEPDIR)/libbayes_a-ArrayOrientation.Po
include ./src/eval/$(DEPDIR)/libbayes_a-ArrayReservoir.Po
include ./src/eval/$(DEPDIR)/libbayes_a-ArrayRestorer.Po
include ./src/eval/$(DEPDIR)/libbayes_a-FullCachePolicy.Po
include ./src/eval/$(DEPDIR)/libbayes_a-LikelihoodEvaluator.Po
include ./src/eval/$(DEPDIR)/libbayes_a-NoCachePolicy.Po
include ./src/eval/$(DEPDIR)/libbayes_a-ParsimonyEvaluator.Po
include ./src/file/$(DEPDIR)/libbayes_a-DiagnosticsFile.Po
include ./src/file/$(DEPDIR)/libbayes_a-OutputFile.Po
include ./src/file/$(DEPDIR)/libbayes_a-ParameterFile.Po
include ./src/file/$(DEPDIR)/libbayes_a-TopologyFile.Po
include ./src/math/$(DEPDIR)/libbayes_a-Arithmetics.Po
include ./src/math/$(DEPDIR)/libbayes_a-Density.Po
include ./src/math/$(DEPDIR)/libbayes_a-Randomness.Po
include ./src/math/$(DEPDIR)/libbayes_a-brent.Po
include ./src/mcmc/$(DEPDIR)/libbayes_a-Chain.Po
include ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Po
include ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Po
include ./src/mcmc/$(DEPDIR)/libbayes_a-SuccessCounter.Po
include ./src/mcmc/$(DEPDIR)/libbayes_a-SwapMatrix.Po
include ./src/model/$(DEPDIR)/libbayes_a-Branch.Po
include ./src/model/$(DEPDIR)/libbayes_a-BranchLengthResource.Po
include ./src/model/$(DEPDIR)/libbayes_a-Category.Po
include ./src/model/$(DEPDIR)/libbayes_a-LengthPart.Po
include ./src/model/$(DEPDIR)/libbayes_a-Partition.Po
include ./src/model/$(DEPDIR)/libbayes_a-ProtModel.Po
include ./src/model/$(DEPDIR)/libbayes_a-RateHelper.Po
include ./src/model/$(DEPDIR)/libbayes_a-TreeAln.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-AbstractParameter.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-BranchLengthsParameter.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-ProtModelParameter.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-RateHetParameter.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Po
include ./src/parameters/$(DEPDIR)/libbayes_a-TopologyParameter.Po
include ./src/parser/$(DEPDIR)/libbayes_a-PhylipParser.Po
include ./src/priors/$(DEPDIR)/libbayes_a-DirichletPrior.Po
include ./src/priors/$(DEPDIR)/libbayes_a-DiscreteModelPrior.Po
include ./src/priors/$(DEPDIR)/libbayes_a-ExponentialPrior.Po
include ./src/priors/$(DEPDIR)/libbayes_a-FixedPrior.Po
include ./src/priors/$(DEPDIR)/libbayes_a-PriorBelief.Po
include ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-AbstractProposal.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-AminoModelJump.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-BranchLengthMultiplier.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-ExtendedSPR.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-ExtendedTBR.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-LikelihoodSPR.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-NodeSlider.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-ParameterProposal.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-ParsimonySPR.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-ProposalSet.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-ProposalType.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-SprMove.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-StatNNI.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-TbrMove.Po
include ./src/proposals/$(DEPDIR)/libbayes_a-TreeLengthMultiplier.Po
include ./src/proposers/$(DEPDIR)/libbayes_a-AbstractProposer.Po
include ./src/proposers/$(DEPDIR)/libbayes_a-DirichletProposer.Po
include ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Po
include ./src/proposers/$(DEPDIR)/libbayes_a-RateDirichletProposer.Po
include ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Po
include ./src/proposers/$(DEPDIR)/libbayes_a-SlidingProposer.Po
include ./src/system/$(DEPDIR)/libbayes_a-BandWidthTest.Po
include ./src/system/$(DEPDIR)/libbayes_a-BitMask.Po
include ./src/system/$(DEPDIR)/libbayes_a-BoundsChecker.Po
include ./src/system/$(DEPDIR)/libbayes_a-ByteFile.Po
include ./src/system/$(DEPDIR)/libbayes_a-NastyGlobalVariables.Po
include ./src/system/$(DEPDIR)/libbayes_a-PartitionAssignment.Po
include ./src/system/$(DEPDIR)/libbayes_a-ProposalRegistry.Po
include ./src/system/$(DEPDIR)/libbayes_a-RunFactory.Po
include ./src/system/$(DEPDIR)/libbayes_a-Serializable.Po
include ./src/system/$(DEPDIR)/libbayes_a-Teebuf.Po
include ./src/system/$(DEPDIR)/libbayes_a-extensions.Po
include ./src/system/$(DEPDIR)/libbayes_a-log_double.Po
include ./src/system/$(DEPDIR)/libbayes_a-time.Po
include ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Po
include ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Po
include ./tests/$(DEPDIR)/exatest-exatest.Po
...
./lib/lcfit/lcfit_src/liblcfit_a-lcfit.o: ./lib/lcfit/lcfit_src/lcfit.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(liblcfit_a_CFLAGS) $(CFLAGS) -MT ./lib/lcfit/lcfit_src/liblcfit_a-lcfit.o -MD -MP -MF ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit.Tpo -c -o ./lib/lcfit/lcfit_src/liblcfit_a-lcfit.o `test -f './lib/lcfit/lcfit_src/lcfit.c' || echo '$(srcdir)/'`./lib/lcfit/lcfit_src/lcfit.c
	$(AM_V_at)$(am__mv) ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit.Tpo ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit.Po
#	$(AM_V_CC)source='./lib/lcfit/lcfit_src/lcfit.c' object='./lib/lcfit/lcfit_src/liblcfit_a-lcfit.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(liblcfit_a_CFLAGS) $(CFLAGS) -c -o ./lib/lcfit/lcfit_src/liblcfit_a-lcfit.o `test -f './lib/lcfit/lcfit_src/lcfit.c' || echo '$(srcdir)/'`./lib/lcfit/lcfit_src/lcfit.c

./lib/lcfit/lcfit_src/liblcfit_a-lcfit.obj: ./lib/lcfit/lcfit_src/lcfit.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(liblcfit_a_CFLAGS) $(CFLAGS) -MT ./lib/lcfit/lcfit_src/liblcfit_a-lcfit.obj -MD -MP -MF ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit.Tpo -c -o ./lib/lcfit/lcfit_src/liblcfit_a-lcfit.obj `if test -f './lib/lcfit/lcfit_src/lcfit.c'; then $(CYGPATH_W) './lib/lcfit/lcfit_src/lcfit.c'; else $(CYGPATH_W) '$(srcdir)/./lib/lcfit/lcfit_src/lcfit.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit.Tpo ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit.Po
#	$(AM_V_CC)source='./lib/lcfit/lcfit_src/lcfit.c' object='./lib/lcfit/lcfit_src/liblcfit_a-lcfit.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
#	$(AM_V_CC)source='./lib/lcfit/lcfit_src/lcfit_select.c' object='./lib/lcfit/lcfit_src/liblcfit_a-lcfit_select.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(liblcfit_a_CFLAGS) $(CFLAGS) -c -o ./lib/lcfit/lcfit_src/liblcfit_a-lcfit_select.o `test -f './lib/lcfit/lcfit_src/lcfit_select.c' || echo '$(srcdir)/'`./lib/lcfit/lcfit_src/lcfit_select.c

./lib/lcfit/lcfit_src/liblcfit_a-lcfit_select.obj: ./lib/lcfit/lcfit_src/lcfit_select.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(liblcfit_a_CFLAGS) $(CFLAGS) -MT ./lib/lcfit/lcfit_src/liblcfit_a-lcfit_select.obj -MD -MP -MF ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit_select.Tpo -c -o ./lib/lcfit/lcfit_src/liblcfit_a-lcfit_select.obj `if test -f './lib/lcfit/lcfit_src/lcfit_select.c'; then $(CYGPATH_W) './lib/lcfit/lcfit_src/lcfit_select.c'; else $(CYGPATH_W) '$(srcdir)/./lib/lcfit/lcfit_src/lcfit_select.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit_select.Tpo ./lib/lcfit/lcfit_src/$(DEPDIR)/liblcfit_a-lcfit_select.Po
...
./lib/pll/libpll_a-alignment.o: ./lib/pll/alignment.c
	...
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-alignment.Tpo ./lib/pll/$(DEPDIR)/libpll_a-alignment.Po
#	$(AM_V_CC)source='./lib/pll/alignment.c' object='./lib/pll/libpll_a-alignment.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-alignment.o `test -f './lib/pll/alignment.c' || echo '$(srcdir)/'`./lib/pll/alignment.c

./lib/pll/libpll_a-alignment.obj: ./lib/pll/alignment.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-alignment.obj -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-alignment.Tpo -c -o ./lib/pll/libpll_a-alignment.obj `if test -f './lib/pll/alignment.c'; then $(CYGPATH_W) './lib/pll/alignment.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/alignment.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-alignment.Tpo ./lib/pll/$(DEPDIR)/libpll_a-alignment.Po
#	$(AM_V_CC)source='./lib/pll/alignment.c' object='./lib/pll/libpll_a-alignment.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
./lib/pll/libpll_a-evaluateGenericSpecial.o: ./lib/pll/evaluateGenericSpecial.c
	...
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-evaluateGenericSpecial.Tpo ./lib/pll/$(DEPDIR)/libpll_a-evaluateGenericSpecial.Po
#	$(AM_V_CC)source='./lib/pll/evaluateGenericSpecial.c' object='./lib/pll/libpll_a-evaluateGenericSpecial.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-evaluateGenericSpecial.o `test -f './lib/pll/evaluateGenericSpecial.c' || echo '$(srcdir)/'`./lib/pll/evaluateGenericSpecial.c

./lib/pll/libpll_a-evaluateGenericSpecial.obj: ./lib/pll/evaluateGenericSpecial.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-evaluateGenericSpecial.obj -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-evaluateGenericSpecial.Tpo -c -o ./lib/pll/libpll_a-evaluateGenericSpecial.obj `if test -f './lib/pll/evaluateGenericSpecial.c'; then $(CYGPATH_W) './lib/pll/evaluateGenericSpecial.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/evaluateGenericSpecial.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-evaluateGenericSpecial.Tpo ./lib/pll/$(DEPDIR)/libpll_a-evaluateGenericSpecial.Po
...
./lib/pll/libpll_a-models.o: ./lib/pll/models.c
	...
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-models.Tpo ./lib/pll/$(DEPDIR)/libpll_a-models.Po
#	$(AM_V_CC)source='./lib/pll/models.c' object='./lib/pll/libpll_a-models.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-models.o `test -f './lib/pll/models.c' || echo '$(srcdir)/'`./lib/pll/models.c

./lib/pll/libpll_a-models.obj: ./lib/pll/models.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-models.obj -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-models.Tpo -c -o ./lib/pll/libpll_a-models.obj `if test -f './lib/pll/models.c'; then $(CYGPATH_W) './lib/pll/models.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/models.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-models.Tpo ./lib/pll/$(DEPDIR)/libpll_a-models.Po
#	$(AM_V_CC)source='./lib/pll/models.c' object='./lib/pll/libpll_a-models.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-models.obj `if test -f './lib/pll/models.c'; then $(CYGPATH_W) './lib/pll/models.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/models.c'; fi`

./lib/pll/libpll_a-newick.o: ./lib/pll/newick.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-newick.o -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-newick.Tpo -c -o ./lib/pll/libpll_a-newick.o `test -f './lib/pll/newick.c' || echo '$(srcdir)/'`./lib/pll/newick.c
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-newick.Tpo ./lib/pll/$(DEPDIR)/libpll_a-newick.Po
#	$(AM_V_CC)source='./lib/pll/newick.c' object='./lib/pll/libpll_a-newick.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-newick.o `test -f './lib/pll/newick.c' || echo '$(srcdir)/'`./lib/pll/newick.c

./lib/pll/libpll_a-newick.obj: ./lib/pll/newick.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-newick.obj -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-newick.Tpo -c -o ./lib/pll/libpll_a-newick.obj `if test -f './lib/pll/newick.c'; then $(CYGPATH_W) './lib/pll/newick.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/newick.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-newick.Tpo ./lib/pll/$(DEPDIR)/libpll_a-newick.Po
#	$(AM_V_CC)source='./lib/pll/newick.c' object='./lib/pll/libpll_a-newick.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
./lib/pll/libpll_a-optimizeModel.o: ./lib/pll/optimizeModel.c
	...
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-optimizeModel.Tpo ./lib/pll/$(DEPDIR)/libpll_a-optimizeModel.Po
#	$(AM_V_CC)source='./lib/pll/optimizeModel.c' object='./lib/pll/libpll_a-optimizeModel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-optimizeModel.o `test -f './lib/pll/optimizeModel.c' || echo '$(srcdir)/'`./lib/pll/optimizeModel.c

./lib/pll/libpll_a-optimizeModel.obj: ./lib/pll/optimizeModel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-optimizeModel.obj -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-optimizeModel.Tpo -c -o ./lib/pll/libpll_a-optimizeModel.obj `if test -f './lib/pll/optimizeModel.c'; then $(CYGPATH_W) './lib/pll/optimizeModel.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/optimizeModel.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-optimizeModel.Tpo ./lib/pll/$(DEPDIR)/libpll_a-optimizeModel.Po
#	$(AM_V_CC)source='./lib/pll/optimizeModel.c' object='./lib/pll/libpll_a-optimizeModel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
./lib/pll/libpll_a-randomTree.o: ./lib/pll/randomTree.c
	...
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-randomTree.Tpo ./lib/pll/$(DEPDIR)/libpll_a-randomTree.Po
#	$(AM_V_CC)source='./lib/pll/randomTree.c' object='./lib/pll/libpll_a-randomTree.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./lib/pll/libpll_a-randomTree.o `test -f './lib/pll/randomTree.c' || echo '$(srcdir)/'`./lib/pll/randomTree.c

./lib/pll/libpll_a-randomTree.obj: ./lib/pll/randomTree.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./lib/pll/libpll_a-randomTree.obj -MD -MP -MF ./lib/pll/$(DEPDIR)/libpll_a-randomTree.Tpo -c -o ./lib/pll/libpll_a-randomTree.obj `if test -f './lib/pll/randomTree.c'; then $(CYGPATH_W) './lib/pll/randomTree.c'; else $(CYGPATH_W) '$(srcdir)/./lib/pll/randomTree.c'; fi`
	$(AM_V_at)$(am__mv) ./lib/pll/$(DEPDIR)/libpll_a-randomTree.Tpo ./lib/pll/$(DEPDIR)/libpll_a-randomTree.Po
#	$(AM_V_CC)source='./lib/pll/randomTree.c' object='./lib/pll/libpll_a-randomTree.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
./src/libpll_a-avxConditional.o: ./src/avxConditional.c
	...
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libpll_a-avxConditional.Tpo ./src/$(DEPDIR)/libpll_a-avxConditional.Po
#	$(AM_V_CC)source='./src/avxConditional.c' object='./src/libpll_a-avxConditional.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./src/libpll_a-avxConditional.o `test -f './src/avxConditional.c' || echo '$(srcdir)/'`./src/avxConditional.c

./src/libpll_a-avxConditional.obj: ./src/avxConditional.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -MT ./src/libpll_a-avxConditional.obj -MD -MP -MF ./src/$(DEPDIR)/libpll_a-avxConditional.Tpo -c -o ./src/libpll_a-avxConditional.obj `if test -f './src/avxConditional.c'; then $(CYGPATH_W) './src/avxConditional.c'; else $(CYGPATH_W) '$(srcdir)/./src/avxConditional.c'; fi`
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libpll_a-avxConditional.Tpo ./src/$(DEPDIR)/libpll_a-avxConditional.Po
#	$(AM_V_CC)source='./src/avxConditional.c' object='./src/libpll_a-avxConditional.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libpll_a_CFLAGS) $(CFLAGS) -c -o ./src/libpll_a-avxConditional.obj `if test -f './src/avxConditional.c'; then $(CYGPATH_W) './src/avxConditional.c'; else $(CYGPATH_W) '$(srcdir)/./src/avxConditional.c'; fi`
...
#	$(AM_V_CXX)source='./src/AdHocIntegrator.cpp' object='./src/libbayes_a-AdHocIntegrator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/libbayes_a-AdHocIntegrator.o `test -f './src/AdHocIntegrator.cpp' || echo '$(srcdir)/'`./src/AdHocIntegrator.cpp

./src/libbayes_a-AdHocIntegrator.obj: ./src/AdHocIntegrator.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/libbayes_a-AdHocIntegrator.obj -MD -MP -MF ./src/$(DEPDIR)/libbayes_a-AdHocIntegrator.Tpo -c -o ./src/libbayes_a-AdHocIntegrator.obj `if test -f './src/AdHocIntegrator.cpp'; then $(CYGPATH_W) './src/AdHocIntegrator.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/AdHocIntegrator.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-AdHocIntegrator.Tpo ./src/$(DEPDIR)/libbayes_a-AdHocIntegrator.Po
...
./src/libbayes_a-ComplexTuner.o: ./src/ComplexTuner.cpp
	...
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-ComplexTuner.Tpo ./src/$(DEPDIR)/libbayes_a-ComplexTuner.Po
#	$(AM_V_CXX)source='./src/ComplexTuner.cpp' object='./src/libbayes_a-ComplexTuner.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/libbayes_a-ComplexTuner.o `test -f './src/ComplexTuner.cpp' || echo '$(srcdir)/'`./src/ComplexTuner.cpp

./src/libbayes_a-ComplexTuner.obj: ./src/ComplexTuner.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/libbayes_a-ComplexTuner.obj -MD -MP -MF ./src/$(DEPDIR)/libbayes_a-ComplexTuner.Tpo -c -o ./src/libbayes_a-ComplexTuner.obj `if test -f './src/ComplexTuner.cpp'; then $(CYGPATH_W) './src/ComplexTuner.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/ComplexTuner.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-ComplexTuner.Tpo ./src/$(DEPDIR)/libbayes_a-ComplexTuner.Po
#	$(AM_V_CXX)source='./src/ComplexTuner.cpp' object='./src/libbayes_a-ComplexTuner.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/libbayes_a-GibbsProposal.o: ./src/GibbsProposal.cpp
	...
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-GibbsProposal.Tpo ./src/$(DEPDIR)/libbayes_a-GibbsProposal.Po
#	$(AM_V_CXX)source='./src/GibbsProposal.cpp' object='./src/libbayes_a-GibbsProposal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/libbayes_a-GibbsProposal.o `test -f './src/GibbsProposal.cpp' || echo '$(srcdir)/'`./src/GibbsProposal.cpp

./src/libbayes_a-GibbsProposal.obj: ./src/GibbsProposal.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/libbayes_a-GibbsProposal.obj -MD -MP -MF ./src/$(DEPDIR)/libbayes_a-GibbsProposal.Tpo -c -o ./src/libbayes_a-GibbsProposal.obj `if test -f './src/GibbsProposal.cpp'; then $(CYGPATH_W) './src/GibbsProposal.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/GibbsProposal.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-GibbsProposal.Tpo ./src/$(DEPDIR)/libbayes_a-GibbsProposal.Po
#	$(AM_V_CXX)source='./src/GibbsProposal.cpp' object='./src/libbayes_a-GibbsProposal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/libbayes_a-GibbsProposal.obj `if test -f './src/GibbsProposal.cpp'; then $(CYGPATH_W) './src/GibbsProposal.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/GibbsProposal.cpp'; fi`

./src/libbayes_a-OptimizedParameter.o: ./src/OptimizedParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/libbayes_a-OptimizedParameter.o -MD -MP -MF ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Tpo -c -o ./src/libbayes_a-OptimizedParameter.o `test -f './src/OptimizedParameter.cpp' || echo '$(srcdir)/'`./src/OptimizedParameter.cpp
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Tpo ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Po
#	$(AM_V_CXX)source='./src/OptimizedParameter.cpp' object='./src/libbayes_a-OptimizedParameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/libbayes_a-OptimizedParameter.o `test -f './src/OptimizedParameter.cpp' || echo '$(srcdir)/'`./src/OptimizedParameter.cpp

./src/libbayes_a-OptimizedParameter.obj: ./src/OptimizedParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/libbayes_a-OptimizedParameter.obj -MD -MP -MF ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Tpo -c -o ./src/libbayes_a-OptimizedParameter.obj `if test -f './src/OptimizedParameter.cpp'; then $(CYGPATH_W) './src/OptimizedParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/OptimizedParameter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Tpo ./src/$(DEPDIR)/libbayes_a-OptimizedParameter.Po
#	$(AM_V_CXX)source='./src/OptimizedParameter.cpp' object='./src/libbayes_a-OptimizedParameter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/TreeIntegrator.cpp' object='./src/libbayes_a-TreeIntegrator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/libbayes_a-TreeIntegrator.o `test -f './src/TreeIntegrator.cpp' || echo '$(srcdir)/'`./src/TreeIntegrator.cpp

./src/libbayes_a-TreeIntegrator.obj: ./src/TreeIntegrator.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/libbayes_a-TreeIntegrator.obj -MD -MP -MF ./src/$(DEPDIR)/libbayes_a-TreeIntegrator.Tpo -c -o ./src/libbayes_a-TreeIntegrator.obj `if test -f './src/TreeIntegrator.cpp'; then $(CYGPATH_W) './src/TreeIntegrator.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/TreeIntegrator.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/$(DEPDIR)/libbayes_a-TreeIntegrator.Tpo ./src/$(DEPDIR)/libbayes_a-TreeIntegrator.Po
#	$(AM_V_CXX)source='./src/TreeIntegrator.cpp' object='./src/libbayes_a-TreeIntegrator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/proposals/libbayes_a-AbstractProposal.o: ./src/proposals/AbstractProposal.cpp
	...
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-AbstractProposal.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-AbstractProposal.Po
#	$(AM_V_CXX)source='./src/proposals/AbstractProposal.cpp' object='./src/proposals/libbayes_a-AbstractProposal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposals/libbayes_a-AbstractProposal.o `test -f './src/proposals/AbstractProposal.cpp' || echo '$(srcdir)/'`./src/proposals/AbstractProposal.cpp

./src/proposals/libbayes_a-AbstractProposal.obj: ./src/proposals/AbstractProposal.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposals/libbayes_a-AbstractProposal.obj -MD -MP -MF ./src/proposals/$(DEPDIR)/libbayes_a-AbstractProposal.Tpo -c -o ./src/proposals/libbayes_a-AbstractProposal.obj `if test -f './src/proposals/AbstractProposal.cpp'; then $(CYGPATH_W) './src/proposals/AbstractProposal.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposals/AbstractProposal.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-AbstractProposal.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-AbstractProposal.Po
#	$(AM_V_CXX)source='./src/proposals/AbstractProposal.cpp' object='./src/proposals/libbayes_a-AbstractProposal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/proposals/libbayes_a-BranchLengthMultiplier.o: ./src/proposals/BranchLengthMultiplier.cpp
	...
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-BranchLengthMultiplier.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-BranchLengthMultiplier.Po
#	$(AM_V_CXX)source='./src/proposals/BranchLengthMultiplier.cpp' object='./src/proposals/libbayes_a-BranchLengthMultiplier.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposals/libbayes_a-BranchLengthMultiplier.o `test -f './src/proposals/BranchLengthMultiplier.cpp' || echo '$(srcdir)/'`./src/proposals/BranchLengthMultiplier.cpp

./src/proposals/libbayes_a-BranchLengthMultiplier.obj: ./src/proposals/BranchLengthMultiplier.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposals/libbayes_a-BranchLengthMultiplier.obj -MD -MP -MF ./src/proposals/$(DEPDIR)/libbayes_a-BranchLengthMultiplier.Tpo -c -o ./src/proposals/libbayes_a-BranchLengthMultiplier.obj `if test -f './src/proposals/BranchLengthMultiplier.cpp'; then $(CYGPATH_W) './src/proposals/BranchLengthMultiplier.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposals/BranchLengthMultiplier.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-BranchLengthMultiplier.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-BranchLengthMultiplier.Po
#	$(AM_V_CXX)source='./src/proposals/BranchLengthMultiplier.cpp' object='./src/proposals/libbayes_a-BranchLengthMultiplier.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposals/libbayes_a-BranchLengthMultiplier.obj `if test -f './src/proposals/BranchLengthMultiplier.cpp'; then $(CYGPATH_W) './src/proposals/BranchLengthMultiplier.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposals/BranchLengthMultiplier.cpp'; fi`

./src/proposals/libbayes_a-DivTimeProposal.o: ./src/proposals/DivTimeProposal.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposals/libbayes_a-DivTimeProposal.o -MD -MP -MF ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Tpo -c -o ./src/proposals/libbayes_a-DivTimeProposal.o `test -f './src/proposals/DivTimeProposal.cpp' || echo '$(srcdir)/'`./src/proposals/DivTimeProposal.cpp
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Po
#	$(AM_V_CXX)source='./src/proposals/DivTimeProposal.cpp' object='./src/proposals/libbayes_a-DivTimeProposal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposals/libbayes_a-DivTimeProposal.o `test -f './src/proposals/DivTimeProposal.cpp' || echo '$(srcdir)/'`./src/proposals/DivTimeProposal.cpp

./src/proposals/libbayes_a-DivTimeProposal.obj: ./src/proposals/DivTimeProposal.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposals/libbayes_a-DivTimeProposal.obj -MD -MP -MF ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Tpo -c -o ./src/proposals/libbayes_a-DivTimeProposal.obj `if test -f './src/proposals/DivTimeProposal.cpp'; then $(CYGPATH_W) './src/proposals/DivTimeProposal.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposals/DivTimeProposal.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-DivTimeProposal.Po
#	$(AM_V_CXX)source='./src/proposals/DivTimeProposal.cpp' object='./src/proposals/libbayes_a-DivTimeProposal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/proposals/libbayes_a-NodeSlider.o: ./src/proposals/NodeSlider.cpp
	...
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-NodeSlider.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-NodeSlider.Po
#	$(AM_V_CXX)source='./src/proposals/NodeSlider.cpp' object='./src/proposals/libbayes_a-NodeSlider.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposals/libbayes_a-NodeSlider.o `test -f './src/proposals/NodeSlider.cpp' || echo '$(srcdir)/'`./src/proposals/NodeSlider.cpp

./src/proposals/libbayes_a-NodeSlider.obj: ./src/proposals/NodeSlider.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposals/libbayes_a-NodeSlider.obj -MD -MP -MF ./src/proposals/$(DEPDIR)/libbayes_a-NodeSlider.Tpo -c -o ./src/proposals/libbayes_a-NodeSlider.obj `if test -f './src/proposals/NodeSlider.cpp'; then $(CYGPATH_W) './src/proposals/NodeSlider.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposals/NodeSlider.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposals/$(DEPDIR)/libbayes_a-NodeSlider.Tpo ./src/proposals/$(DEPDIR)/libbayes_a-NodeSlider.Po
#	$(AM_V_CXX)source='./src/proposals/NodeSlider.cpp' object='./src/proposals/libbayes_a-NodeSlider.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/parameters/libbayes_a-BranchLengthsParameter.o: ./src/parameters/BranchLengthsParameter.cpp
	...
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-BranchLengthsParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-BranchLengthsParameter.Po
#	$(AM_V_CXX)source='./src/parameters/BranchLengthsParameter.cpp' object='./src/parameters/libbayes_a-BranchLengthsParameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-BranchLengthsParameter.o `test -f './src/parameters/BranchLengthsParameter.cpp' || echo '$(srcdir)/'`./src/parameters/BranchLengthsParameter.cpp

./src/parameters/libbayes_a-BranchLengthsParameter.obj: ./src/parameters/BranchLengthsParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-BranchLengthsParameter.obj -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-BranchLengthsParameter.Tpo -c -o ./src/parameters/libbayes_a-BranchLengthsParameter.obj `if test -f './src/parameters/BranchLengthsParameter.cpp'; then $(CYGPATH_W) './src/parameters/BranchLengthsParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/BranchLengthsParameter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-BranchLengthsParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-BranchLengthsParameter.Po
#	$(AM_V_CXX)source='./src/parameters/BranchLengthsParameter.cpp' object='./src/parameters/libbayes_a-BranchLengthsParameter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-BranchLengthsParameter.obj `if test -f './src/parameters/BranchLengthsParameter.cpp'; then $(CYGPATH_W) './src/parameters/BranchLengthsParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/BranchLengthsParameter.cpp'; fi`

./src/parameters/libbayes_a-FrequencyParameter.o: ./src/parameters/FrequencyParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-FrequencyParameter.o -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Tpo -c -o ./src/parameters/libbayes_a-FrequencyParameter.o `test -f './src/parameters/FrequencyParameter.cpp' || echo '$(srcdir)/'`./src/parameters/FrequencyParameter.cpp
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Po
#	$(AM_V_CXX)source='./src/parameters/FrequencyParameter.cpp' object='./src/parameters/libbayes_a-FrequencyParameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-FrequencyParameter.o `test -f './src/parameters/FrequencyParameter.cpp' || echo '$(srcdir)/'`./src/parameters/FrequencyParameter.cpp

./src/parameters/libbayes_a-FrequencyParameter.obj: ./src/parameters/FrequencyParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-FrequencyParameter.obj -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Tpo -c -o ./src/parameters/libbayes_a-FrequencyParameter.obj `if test -f './src/parameters/FrequencyParameter.cpp'; then $(CYGPATH_W) './src/parameters/FrequencyParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/FrequencyParameter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-FrequencyParameter.Po
#	$(AM_V_CXX)source='./src/parameters/FrequencyParameter.cpp' object='./src/parameters/libbayes_a-FrequencyParameter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-FrequencyParameter.obj `if test -f './src/parameters/FrequencyParameter.cpp'; then $(CYGPATH_W) './src/parameters/FrequencyParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/FrequencyParameter.cpp'; fi`

./src/parameters/libbayes_a-ParameterContent.o: ./src/parameters/ParameterContent.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-ParameterContent.o -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Tpo -c -o ./src/parameters/libbayes_a-ParameterContent.o `test -f './src/parameters/ParameterContent.cpp' || echo '$(srcdir)/'`./src/parameters/ParameterContent.cpp
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Po
#	$(AM_V_CXX)source='./src/parameters/ParameterContent.cpp' object='./src/parameters/libbayes_a-ParameterContent.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-ParameterContent.o `test -f './src/parameters/ParameterContent.cpp' || echo '$(srcdir)/'`./src/parameters/ParameterContent.cpp

./src/parameters/libbayes_a-ParameterContent.obj: ./src/parameters/ParameterContent.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-ParameterContent.obj -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Tpo -c -o ./src/parameters/libbayes_a-ParameterContent.obj `if test -f './src/parameters/ParameterContent.cpp'; then $(CYGPATH_W) './src/parameters/ParameterContent.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/ParameterContent.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-ParameterContent.Po
#	$(AM_V_CXX)source='./src/parameters/ParameterContent.cpp' object='./src/parameters/libbayes_a-ParameterContent.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/parameters/RateHetParameter.cpp' object='./src/parameters/libbayes_a-RateHetParameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-RateHetParameter.o `test -f './src/parameters/RateHetParameter.cpp' || echo '$(srcdir)/'`./src/parameters/RateHetParameter.cpp

./src/parameters/libbayes_a-RateHetParameter.obj: ./src/parameters/RateHetParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-RateHetParameter.obj -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-RateHetParameter.Tpo -c -o ./src/parameters/libbayes_a-RateHetParameter.obj `if test -f './src/parameters/RateHetParameter.cpp'; then $(CYGPATH_W) './src/parameters/RateHetParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/RateHetParameter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-RateHetParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-RateHetParameter.Po
#	$(AM_V_CXX)source='./src/parameters/RateHetParameter.cpp' object='./src/parameters/libbayes_a-RateHetParameter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-RateHetParameter.obj `if test -f './src/parameters/RateHetParameter.cpp'; then $(CYGPATH_W) './src/parameters/RateHetParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/RateHetParameter.cpp'; fi`

./src/parameters/libbayes_a-RevMatParameter.o: ./src/parameters/RevMatParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-RevMatParameter.o -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Tpo -c -o ./src/parameters/libbayes_a-RevMatParameter.o `test -f './src/parameters/RevMatParameter.cpp' || echo '$(srcdir)/'`./src/parameters/RevMatParameter.cpp
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Po
#	$(AM_V_CXX)source='./src/parameters/RevMatParameter.cpp' object='./src/parameters/libbayes_a-RevMatParameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-RevMatParameter.o `test -f './src/parameters/RevMatParameter.cpp' || echo '$(srcdir)/'`./src/parameters/RevMatParameter.cpp

./src/parameters/libbayes_a-RevMatParameter.obj: ./src/parameters/RevMatParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-RevMatParameter.obj -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Tpo -c -o ./src/parameters/libbayes_a-RevMatParameter.obj `if test -f './src/parameters/RevMatParameter.cpp'; then $(CYGPATH_W) './src/parameters/RevMatParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/RevMatParameter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-RevMatParameter.Po
...
./src/parameters/libbayes_a-TopologyParameter.o: ./src/parameters/TopologyParameter.cpp
	...
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-TopologyParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-TopologyParameter.Po
#	$(AM_V_CXX)source='./src/parameters/TopologyParameter.cpp' object='./src/parameters/libbayes_a-TopologyParameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-TopologyParameter.o `test -f './src/parameters/TopologyParameter.cpp' || echo '$(srcdir)/'`./src/parameters/TopologyParameter.cpp

./src/parameters/libbayes_a-TopologyParameter.obj: ./src/parameters/TopologyParameter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parameters/libbayes_a-TopologyParameter.obj -MD -MP -MF ./src/parameters/$(DEPDIR)/libbayes_a-TopologyParameter.Tpo -c -o ./src/parameters/libbayes_a-TopologyParameter.obj `if test -f './src/parameters/TopologyParameter.cpp'; then $(CYGPATH_W) './src/parameters/TopologyParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/TopologyParameter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parameters/$(DEPDIR)/libbayes_a-TopologyParameter.Tpo ./src/parameters/$(DEPDIR)/libbayes_a-TopologyParameter.Po
#	$(AM_V_CXX)source='./src/parameters/TopologyParameter.cpp' object='./src/parameters/libbayes_a-TopologyParameter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parameters/libbayes_a-TopologyParameter.obj `if test -f './src/parameters/TopologyParameter.cpp'; then $(CYGPATH_W) './src/parameters/TopologyParameter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parameters/TopologyParameter.cpp'; fi`

./src/config/libbayes_a-BlockParams.o: ./src/config/BlockParams.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/config/libbayes_a-BlockParams.o -MD -MP -MF ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Tpo -c -o ./src/config/libbayes_a-BlockParams.o `test -f './src/config/BlockParams.cpp' || echo '$(srcdir)/'`./src/config/BlockParams.cpp
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Tpo ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Po
#	$(AM_V_CXX)source='./src/config/BlockParams.cpp' object='./src/config/libbayes_a-BlockParams.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/config/libbayes_a-BlockParams.o `test -f './src/config/BlockParams.cpp' || echo '$(srcdir)/'`./src/config/BlockParams.cpp

./src/config/libbayes_a-BlockParams.obj: ./src/config/BlockParams.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/config/libbayes_a-BlockParams.obj -MD -MP -MF ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Tpo -c -o ./src/config/libbayes_a-BlockParams.obj `if test -f './src/config/BlockParams.cpp'; then $(CYGPATH_W) './src/config/BlockParams.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/config/BlockParams.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Tpo ./src/config/$(DEPDIR)/libbayes_a-BlockParams.Po
#	$(AM_V_CXX)source='./src/config/BlockParams.cpp' object='./src/config/libbayes_a-BlockParams.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/config/BlockPrior.cpp' object='./src/config/libbayes_a-BlockPrior.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/config/libbayes_a-BlockPrior.o `test -f './src/config/BlockPrior.cpp' || echo '$(srcdir)/'`./src/config/BlockPrior.cpp

./src/config/libbayes_a-BlockPrior.obj: ./src/config/BlockPrior.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/config/libbayes_a-BlockPrior.obj -MD -MP -MF ./src/config/$(DEPDIR)/libbayes_a-BlockPrior.Tpo -c -o ./src/config/libbayes_a-BlockPrior.obj `if test -f './src/config/BlockPrior.cpp'; then $(CYGPATH_W) './src/config/BlockPrior.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/config/BlockPrior.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-BlockPrior.Tpo ./src/config/$(DEPDIR)/libbayes_a-BlockPrior.Po
...
./src/config/libbayes_a-BlockRunParameters.o: ./src/config/BlockRunParameters.cpp
	...
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-BlockRunParameters.Tpo ./src/config/$(DEPDIR)/libbayes_a-BlockRunParameters.Po
#	$(AM_V_CXX)source='./src/config/BlockRunParameters.cpp' object='./src/config/libbayes_a-BlockRunParameters.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/config/libbayes_a-BlockRunParameters.o `test -f './src/config/BlockRunParameters.cpp' || echo '$(srcdir)/'`./src/config/BlockRunParameters.cpp

./src/config/libbayes_a-BlockRunParameters.obj: ./src/config/BlockRunParameters.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/config/libbayes_a-BlockRunParameters.obj -MD -MP -MF ./src/config/$(DEPDIR)/libbayes_a-BlockRunParameters.Tpo -c -o ./src/config/libbayes_a-BlockRunParameters.obj `if test -f './src/config/BlockRunParameters.cpp'; then $(CYGPATH_W) './src/config/BlockRunParameters.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/config/BlockRunParameters.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-BlockRunParameters.Tpo ./src/config/$(DEPDIR)/libbayes_a-BlockRunParameters.Po
#	$(AM_V_CXX)source='./src/config/BlockRunParameters.cpp' object='./src/config/libbayes_a-BlockRunParameters.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/config/libbayes_a-BlockRunParameters.obj `if test -f './src/config/BlockRunParameters.cpp'; then $(CYGPATH_W) './src/config/BlockRunParameters.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/config/BlockRunParameters.cpp'; fi`

./src/config/libbayes_a-CommandLine.o: ./src/config/CommandLine.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/config/libbayes_a-CommandLine.o -MD -MP -MF ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Tpo -c -o ./src/config/libbayes_a-CommandLine.o `test -f './src/config/CommandLine.cpp' || echo '$(srcdir)/'`./src/config/CommandLine.cpp
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Tpo ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Po
#	$(AM_V_CXX)source='./src/config/CommandLine.cpp' object='./src/config/libbayes_a-CommandLine.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/config/libbayes_a-CommandLine.o `test -f './src/config/CommandLine.cpp' || echo '$(srcdir)/'`./src/config/CommandLine.cpp

./src/config/libbayes_a-CommandLine.obj: ./src/config/CommandLine.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/config/libbayes_a-CommandLine.obj -MD -MP -MF ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Tpo -c -o ./src/config/libbayes_a-CommandLine.obj `if test -f './src/config/CommandLine.cpp'; then $(CYGPATH_W) './src/config/CommandLine.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/config/CommandLine.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Tpo ./src/config/$(DEPDIR)/libbayes_a-CommandLine.Po
#	$(AM_V_CXX)source='./src/config/CommandLine.cpp' object='./src/config/libbayes_a-CommandLine.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/priors/DiscreteModelPrior.cpp' object='./src/priors/libbayes_a-DiscreteModelPrior.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/priors/libbayes_a-DiscreteModelPrior.o `test -f './src/priors/DiscreteModelPrior.cpp' || echo '$(srcdir)/'`./src/priors/DiscreteModelPrior.cpp

./src/priors/libbayes_a-DiscreteModelPrior.obj: ./src/priors/DiscreteModelPrior.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/priors/libbayes_a-DiscreteModelPrior.obj -MD -MP -MF ./src/priors/$(DEPDIR)/libbayes_a-DiscreteModelPrior.Tpo -c -o ./src/priors/libbayes_a-DiscreteModelPrior.obj `if test -f './src/priors/DiscreteModelPrior.cpp'; then $(CYGPATH_W) './src/priors/DiscreteModelPrior.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/priors/DiscreteModelPrior.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/priors/$(DEPDIR)/libbayes_a-DiscreteModelPrior.Tpo ./src/priors/$(DEPDIR)/libbayes_a-DiscreteModelPrior.Po
...
./src/priors/libbayes_a-PriorBelief.o: ./src/priors/PriorBelief.cpp
	...
	$(AM_V_at)$(am__mv) ./src/priors/$(DEPDIR)/libbayes_a-PriorBelief.Tpo ./src/priors/$(DEPDIR)/libbayes_a-PriorBelief.Po
#	$(AM_V_CXX)source='./src/priors/PriorBelief.cpp' object='./src/priors/libbayes_a-PriorBelief.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/priors/libbayes_a-PriorBelief.o `test -f './src/priors/PriorBelief.cpp' || echo '$(srcdir)/'`./src/priors/PriorBelief.cpp

./src/priors/libbayes_a-PriorBelief.obj: ./src/priors/PriorBelief.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/priors/libbayes_a-PriorBelief.obj -MD -MP -MF ./src/priors/$(DEPDIR)/libbayes_a-PriorBelief.Tpo -c -o ./src/priors/libbayes_a-PriorBelief.obj `if test -f './src/priors/PriorBelief.cpp'; then $(CYGPATH_W) './src/priors/PriorBelief.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/priors/PriorBelief.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/priors/$(DEPDIR)/libbayes_a-PriorBelief.Tpo ./src/priors/$(DEPDIR)/libbayes_a-PriorBelief.Po
#	$(AM_V_CXX)source='./src/priors/PriorBelief.cpp' object='./src/priors/libbayes_a-PriorBelief.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/priors/libbayes_a-PriorBelief.obj `if test -f './src/priors/PriorBelief.cpp'; then $(CYGPATH_W) './src/priors/PriorBelief.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/priors/PriorBelief.cpp'; fi`

./src/priors/libbayes_a-UniformPrior.o: ./src/priors/UniformPrior.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/priors/libbayes_a-UniformPrior.o -MD -MP -MF ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Tpo -c -o ./src/priors/libbayes_a-UniformPrior.o `test -f './src/priors/UniformPrior.cpp' || echo '$(srcdir)/'`./src/priors/UniformPrior.cpp
	$(AM_V_at)$(am__mv) ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Tpo ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Po
#	$(AM_V_CXX)source='./src/priors/UniformPrior.cpp' object='./src/priors/libbayes_a-UniformPrior.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/priors/libbayes_a-UniformPrior.o `test -f './src/priors/UniformPrior.cpp' || echo '$(srcdir)/'`./src/priors/UniformPrior.cpp

./src/priors/libbayes_a-UniformPrior.obj: ./src/priors/UniformPrior.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/priors/libbayes_a-UniformPrior.obj -MD -MP -MF ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Tpo -c -o ./src/priors/libbayes_a-UniformPrior.obj `if test -f './src/priors/UniformPrior.cpp'; then $(CYGPATH_W) './src/priors/UniformPrior.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/priors/UniformPrior.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Tpo ./src/priors/$(DEPDIR)/libbayes_a-UniformPrior.Po
#	$(AM_V_CXX)source='./src/priors/UniformPrior.cpp' object='./src/priors/libbayes_a-UniformPrior.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/proposers/libbayes_a-DirichletProposer.o: ./src/proposers/DirichletProposer.cpp
	...
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-DirichletProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-DirichletProposer.Po
#	$(AM_V_CXX)source='./src/proposers/DirichletProposer.cpp' object='./src/proposers/libbayes_a-DirichletProposer.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposers/libbayes_a-DirichletProposer.o `test -f './src/proposers/DirichletProposer.cpp' || echo '$(srcdir)/'`./src/proposers/DirichletProposer.cpp

./src/proposers/libbayes_a-DirichletProposer.obj: ./src/proposers/DirichletProposer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposers/libbayes_a-DirichletProposer.obj -MD -MP -MF ./src/proposers/$(DEPDIR)/libbayes_a-DirichletProposer.Tpo -c -o ./src/proposers/libbayes_a-DirichletProposer.obj `if test -f './src/proposers/DirichletProposer.cpp'; then $(CYGPATH_W) './src/proposers/DirichletProposer.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposers/DirichletProposer.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-DirichletProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-DirichletProposer.Po
#	$(AM_V_CXX)source='./src/proposers/DirichletProposer.cpp' object='./src/proposers/libbayes_a-DirichletProposer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposers/libbayes_a-DirichletProposer.obj `if test -f './src/proposers/DirichletProposer.cpp'; then $(CYGPATH_W) './src/proposers/DirichletProposer.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposers/DirichletProposer.cpp'; fi`

./src/proposers/libbayes_a-MultiplierProposer.o: ./src/proposers/MultiplierProposer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposers/libbayes_a-MultiplierProposer.o -MD -MP -MF ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Tpo -c -o ./src/proposers/libbayes_a-MultiplierProposer.o `test -f './src/proposers/MultiplierProposer.cpp' || echo '$(srcdir)/'`./src/proposers/MultiplierProposer.cpp
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Po
#	$(AM_V_CXX)source='./src/proposers/MultiplierProposer.cpp' object='./src/proposers/libbayes_a-MultiplierProposer.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposers/libbayes_a-MultiplierProposer.o `test -f './src/proposers/MultiplierProposer.cpp' || echo '$(srcdir)/'`./src/proposers/MultiplierProposer.cpp

./src/proposers/libbayes_a-MultiplierProposer.obj: ./src/proposers/MultiplierProposer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposers/libbayes_a-MultiplierProposer.obj -MD -MP -MF ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Tpo -c -o ./src/proposers/libbayes_a-MultiplierProposer.obj `if test -f './src/proposers/MultiplierProposer.cpp'; then $(CYGPATH_W) './src/proposers/MultiplierProposer.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposers/MultiplierProposer.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-MultiplierProposer.Po
#	$(AM_V_CXX)source='./src/proposers/MultiplierProposer.cpp' object='./src/proposers/libbayes_a-MultiplierProposer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/proposers/RateDirichletProposer.cpp' object='./src/proposers/libbayes_a-RateDirichletProposer.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposers/libbayes_a-RateDirichletProposer.o `test -f './src/proposers/RateDirichletProposer.cpp' || echo '$(srcdir)/'`./src/proposers/RateDirichletProposer.cpp

./src/proposers/libbayes_a-RateDirichletProposer.obj: ./src/proposers/RateDirichletProposer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposers/libbayes_a-RateDirichletProposer.obj -MD -MP -MF ./src/proposers/$(DEPDIR)/libbayes_a-RateDirichletProposer.Tpo -c -o ./src/proposers/libbayes_a-RateDirichletProposer.obj `if test -f './src/proposers/RateDirichletProposer.cpp'; then $(CYGPATH_W) './src/proposers/RateDirichletProposer.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposers/RateDirichletProposer.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-RateDirichletProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-RateDirichletProposer.Po
#	$(AM_V_CXX)source='./src/proposers/RateDirichletProposer.cpp' object='./src/proposers/libbayes_a-RateDirichletProposer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposers/libbayes_a-RateDirichletProposer.obj `if test -f './src/proposers/RateDirichletProposer.cpp'; then $(CYGPATH_W) './src/proposers/RateDirichletProposer.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposers/RateDirichletProposer.cpp'; fi`

./src/proposers/libbayes_a-RateSlidingProposer.o: ./src/proposers/RateSlidingProposer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposers/libbayes_a-RateSlidingProposer.o -MD -MP -MF ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Tpo -c -o ./src/proposers/libbayes_a-RateSlidingProposer.o `test -f './src/proposers/RateSlidingProposer.cpp' || echo '$(srcdir)/'`./src/proposers/RateSlidingProposer.cpp
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Po
#	$(AM_V_CXX)source='./src/proposers/RateSlidingProposer.cpp' object='./src/proposers/libbayes_a-RateSlidingProposer.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/proposers/libbayes_a-RateSlidingProposer.o `test -f './src/proposers/RateSlidingProposer.cpp' || echo '$(srcdir)/'`./src/proposers/RateSlidingProposer.cpp

./src/proposers/libbayes_a-RateSlidingProposer.obj: ./src/proposers/RateSlidingProposer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/proposers/libbayes_a-RateSlidingProposer.obj -MD -MP -MF ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Tpo -c -o ./src/proposers/libbayes_a-RateSlidingProposer.obj `if test -f './src/proposers/RateSlidingProposer.cpp'; then $(CYGPATH_W) './src/proposers/RateSlidingProposer.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/proposers/RateSlidingProposer.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Tpo ./src/proposers/$(DEPDIR)/libbayes_a-RateSlidingProposer.Po
#	$(AM_V_CXX)source='./src/proposers/RateSlidingProposer.cpp' object='./src/proposers/libbayes_a-RateSlidingProposer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/file/libbayes_a-DiagnosticsFile.o: ./src/file/DiagnosticsFile.cpp
	...
	$(AM_V_at)$(am__mv) ./src/file/$(DEPDIR)/libbayes_a-DiagnosticsFile.Tpo ./src/file/$(DEPDIR)/libbayes_a-DiagnosticsFile.Po
#	$(AM_V_CXX)source='./src/file/DiagnosticsFile.cpp' object='./src/file/libbayes_a-DiagnosticsFile.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/file/libbayes_a-DiagnosticsFile.o `test -f './src/file/DiagnosticsFile.cpp' || echo '$(srcdir)/'`./src/file/DiagnosticsFile.cpp

./src/file/libbayes_a-DiagnosticsFile.obj: ./src/file/DiagnosticsFile.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/file/libbayes_a-DiagnosticsFile.obj -MD -MP -MF ./src/file/$(DEPDIR)/libbayes_a-DiagnosticsFile.Tpo -c -o ./src/file/libbayes_a-DiagnosticsFile.obj `if test -f './src/file/DiagnosticsFile.cpp'; then $(CYGPATH_W) './src/file/DiagnosticsFile.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/file/DiagnosticsFile.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/file/$(DEPDIR)/libbayes_a-DiagnosticsFile.Tpo ./src/file/$(DEPDIR)/libbayes_a-DiagnosticsFile.Po
#	$(AM_V_CXX)source='./src/file/DiagnosticsFile.cpp' object='./src/file/libbayes_a-DiagnosticsFile.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/eval/libbayes_a-ArrayReservoir.o: ./src/eval/ArrayReservoir.cpp
	...
	$(AM_V_at)$(am__mv) ./src/eval/$(DEPDIR)/libbayes_a-ArrayReservoir.Tpo ./src/eval/$(DEPDIR)/libbayes_a-ArrayReservoir.Po
#	$(AM_V_CXX)source='./src/eval/ArrayReservoir.cpp' object='./src/eval/libbayes_a-ArrayReservoir.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/eval/libbayes_a-ArrayReservoir.o `test -f './src/eval/ArrayReservoir.cpp' || echo '$(srcdir)/'`./src/eval/ArrayReservoir.cpp

./src/eval/libbayes_a-ArrayReservoir.obj: ./src/eval/ArrayReservoir.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/eval/libbayes_a-ArrayReservoir.obj -MD -MP -MF ./src/eval/$(DEPDIR)/libbayes_a-ArrayReservoir.Tpo -c -o ./src/eval/libbayes_a-ArrayReservoir.obj `if test -f './src/eval/ArrayReservoir.cpp'; then $(CYGPATH_W) './src/eval/ArrayReservoir.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/eval/ArrayReservoir.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/eval/$(DEPDIR)/libbayes_a-ArrayReservoir.Tpo ./src/eval/$(DEPDIR)/libbayes_a-ArrayReservoir.Po
#	$(AM_V_CXX)source='./src/eval/ArrayReservoir.cpp' object='./src/eval/libbayes_a-ArrayReservoir.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/eval/libbayes_a-FullCachePolicy.o: ./src/eval/FullCachePolicy.cpp
	...
	$(AM_V_at)$(am__mv) ./src/eval/$(DEPDIR)/libbayes_a-FullCachePolicy.Tpo ./src/eval/$(DEPDIR)/libbayes_a-FullCachePolicy.Po
#	$(AM_V_CXX)source='./src/eval/FullCachePolicy.cpp' object='./src/eval/libbayes_a-FullCachePolicy.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/eval/libbayes_a-FullCachePolicy.o `test -f './src/eval/FullCachePolicy.cpp' || echo '$(srcdir)/'`./src/eval/FullCachePolicy.cpp

./src/eval/libbayes_a-FullCachePolicy.obj: ./src/eval/FullCachePolicy.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/eval/libbayes_a-FullCachePolicy.obj -MD -MP -MF ./src/eval/$(DEPDIR)/libbayes_a-FullCachePolicy.Tpo -c -o ./src/eval/libbayes_a-FullCachePolicy.obj `if test -f './src/eval/FullCachePolicy.cpp'; then $(CYGPATH_W) './src/eval/FullCachePolicy.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/eval/FullCachePolicy.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/eval/$(DEPDIR)/libbayes_a-FullCachePolicy.Tpo ./src/eval/$(DEPDIR)/libbayes_a-FullCachePolicy.Po
#	$(AM_V_CXX)source='./src/eval/FullCachePolicy.cpp' object='./src/eval/libbayes_a-FullCachePolicy.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/parser/libbayes_a-PhylipParser.o: ./src/parser/PhylipParser.cpp
	...
	$(AM_V_at)$(am__mv) ./src/parser/$(DEPDIR)/libbayes_a-PhylipParser.Tpo ./src/parser/$(DEPDIR)/libbayes_a-PhylipParser.Po
#	$(AM_V_CXX)source='./src/parser/PhylipParser.cpp' object='./src/parser/libbayes_a-PhylipParser.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parser/libbayes_a-PhylipParser.o `test -f './src/parser/PhylipParser.cpp' || echo '$(srcdir)/'`./src/parser/PhylipParser.cpp

./src/parser/libbayes_a-PhylipParser.obj: ./src/parser/PhylipParser.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/parser/libbayes_a-PhylipParser.obj -MD -MP -MF ./src/parser/$(DEPDIR)/libbayes_a-PhylipParser.Tpo -c -o ./src/parser/libbayes_a-PhylipParser.obj `if test -f './src/parser/PhylipParser.cpp'; then $(CYGPATH_W) './src/parser/PhylipParser.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parser/PhylipParser.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/parser/$(DEPDIR)/libbayes_a-PhylipParser.Tpo ./src/parser/$(DEPDIR)/libbayes_a-PhylipParser.Po
#	$(AM_V_CXX)source='./src/parser/PhylipParser.cpp' object='./src/parser/libbayes_a-PhylipParser.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/parser/libbayes_a-PhylipParser.obj `if test -f './src/parser/PhylipParser.cpp'; then $(CYGPATH_W) './src/parser/PhylipParser.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/parser/PhylipParser.cpp'; fi`

./src/tree-parse/libbayes_a-BasicTreeReader.o: ./src/tree-parse/BasicTreeReader.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/tree-parse/libbayes_a-BasicTreeReader.o -MD -MP -MF ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Tpo -c -o ./src/tree-parse/libbayes_a-BasicTreeReader.o `test -f './src/tree-parse/BasicTreeReader.cpp' || echo '$(srcdir)/'`./src/tree-parse/BasicTreeReader.cpp
	$(AM_V_at)$(am__mv) ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Tpo ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Po
#	$(AM_V_CXX)source='./src/tree-parse/BasicTreeReader.cpp' object='./src/tree-parse/libbayes_a-BasicTreeReader.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/tree-parse/libbayes_a-BasicTreeReader.o `test -f './src/tree-parse/BasicTreeReader.cpp' || echo '$(srcdir)/'`./src/tree-parse/BasicTreeReader.cpp

./src/tree-parse/libbayes_a-BasicTreeReader.obj: ./src/tree-parse/BasicTreeReader.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/tree-parse/libbayes_a-BasicTreeReader.obj -MD -MP -MF ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Tpo -c -o ./src/tree-parse/libbayes_a-BasicTreeReader.obj `if test -f './src/tree-parse/BasicTreeReader.cpp'; then $(CYGPATH_W) './src/tree-parse/BasicTreeReader.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/tree-parse/BasicTreeReader.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Tpo ./src/tree-parse/$(DEPDIR)/libbayes_a-BasicTreeReader.Po
#	$(AM_V_CXX)source='./src/tree-parse/BasicTreeReader.cpp' object='./src/tree-parse/libbayes_a-BasicTreeReader.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/tree-parse/libbayes_a-BasicTreeReader.obj `if test -f './src/tree-parse/BasicTreeReader.cpp'; then $(CYGPATH_W) './src/tree-parse/BasicTreeReader.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/tree-parse/BasicTreeReader.cpp'; fi`

./src/tree-parse/libbayes_a-TreeProcessor.o: ./src/tree-parse/TreeProcessor.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/tree-parse/libbayes_a-TreeProcessor.o -MD -MP -MF ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Tpo -c -o ./src/tree-parse/libbayes_a-TreeProcessor.o `test -f './src/tree-parse/TreeProcessor.cpp' || echo '$(srcdir)/'`./src/tree-parse/TreeProcessor.cpp
	$(AM_V_at)$(am__mv) ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Tpo ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Po
#	$(AM_V_CXX)source='./src/tree-parse/TreeProcessor.cpp' object='./src/tree-parse/libbayes_a-TreeProcessor.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/tree-parse/libbayes_a-TreeProcessor.o `test -f './src/tree-parse/TreeProcessor.cpp' || echo '$(srcdir)/'`./src/tree-parse/TreeProcessor.cpp

./src/tree-parse/libbayes_a-TreeProcessor.obj: ./src/tree-parse/TreeProcessor.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/tree-parse/libbayes_a-TreeProcessor.obj -MD -MP -MF ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Tpo -c -o ./src/tree-parse/libbayes_a-TreeProcessor.obj `if test -f './src/tree-parse/TreeProcessor.cpp'; then $(CYGPATH_W) './src/tree-parse/TreeProcessor.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/tree-parse/TreeProcessor.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Tpo ./src/tree-parse/$(DEPDIR)/libbayes_a-TreeProcessor.Po
#	$(AM_V_CXX)source='./src/tree-parse/TreeProcessor.cpp' object='./src/tree-parse/libbayes_a-TreeProcessor.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/contrib/BipartitionExtractor.cpp' object='./src/contrib/libbayes_a-BipartitionExtractor.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/contrib/libbayes_a-BipartitionExtractor.o `test -f './src/contrib/BipartitionExtractor.cpp' || echo '$(srcdir)/'`./src/contrib/BipartitionExtractor.cpp

./src/contrib/libbayes_a-BipartitionExtractor.obj: ./src/contrib/BipartitionExtractor.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/contrib/libbayes_a-BipartitionExtractor.obj -MD -MP -MF ./src/contrib/$(DEPDIR)/libbayes_a-BipartitionExtractor.Tpo -c -o ./src/contrib/libbayes_a-BipartitionExtractor.obj `if test -f './src/contrib/BipartitionExtractor.cpp'; then $(CYGPATH_W) './src/contrib/BipartitionExtractor.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/contrib/BipartitionExtractor.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/contrib/$(DEPDIR)/libbayes_a-BipartitionExtractor.Tpo ./src/contrib/$(DEPDIR)/libbayes_a-BipartitionExtractor.Po
#	$(AM_V_CXX)source='./src/contrib/BipartitionExtractor.cpp' object='./src/contrib/libbayes_a-BipartitionExtractor.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/contrib/libbayes_a-CredibleSet.o: ./src/contrib/CredibleSet.cpp
	...
	$(AM_V_at)$(am__mv) ./src/contrib/$(DEPDIR)/libbayes_a-CredibleSet.Tpo ./src/contrib/$(DEPDIR)/libbayes_a-CredibleSet.Po
#	$(AM_V_CXX)source='./src/contrib/CredibleSet.cpp' object='./src/contrib/libbayes_a-CredibleSet.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/contrib/libbayes_a-CredibleSet.o `test -f './src/contrib/CredibleSet.cpp' || echo '$(srcdir)/'`./src/contrib/CredibleSet.cpp

./src/contrib/libbayes_a-CredibleSet.obj: ./src/contrib/CredibleSet.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/contrib/libbayes_a-CredibleSet.obj -MD -MP -MF ./src/contrib/$(DEPDIR)/libbayes_a-CredibleSet.Tpo -c -o ./src/contrib/libbayes_a-CredibleSet.obj `if test -f './src/contrib/CredibleSet.cpp'; then $(CYGPATH_W) './src/contrib/CredibleSet.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/contrib/CredibleSet.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/contrib/$(DEPDIR)/libbayes_a-CredibleSet.Tpo ./src/contrib/$(DEPDIR)/libbayes_a-CredibleSet.Po
...
./src/mcmc/libbayes_a-Chain.o: ./src/mcmc/Chain.cpp
	...
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-Chain.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-Chain.Po
#	$(AM_V_CXX)source='./src/mcmc/Chain.cpp' object='./src/mcmc/libbayes_a-Chain.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/mcmc/libbayes_a-Chain.o `test -f './src/mcmc/Chain.cpp' || echo '$(srcdir)/'`./src/mcmc/Chain.cpp

./src/mcmc/libbayes_a-Chain.obj: ./src/mcmc/Chain.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/mcmc/libbayes_a-Chain.obj -MD -MP -MF ./src/mcmc/$(DEPDIR)/libbayes_a-Chain.Tpo -c -o ./src/mcmc/libbayes_a-Chain.obj `if test -f './src/mcmc/Chain.cpp'; then $(CYGPATH_W) './src/mcmc/Chain.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/mcmc/Chain.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-Chain.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-Chain.Po
#	$(AM_V_CXX)source='./src/mcmc/Chain.cpp' object='./src/mcmc/libbayes_a-Chain.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/mcmc/libbayes_a-Chain.obj `if test -f './src/mcmc/Chain.cpp'; then $(CYGPATH_W) './src/mcmc/Chain.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/mcmc/Chain.cpp'; fi`

./src/mcmc/libbayes_a-CoupledChains.o: ./src/mcmc/CoupledChains.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/mcmc/libbayes_a-CoupledChains.o -MD -MP -MF ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Tpo -c -o ./src/mcmc/libbayes_a-CoupledChains.o `test -f './src/mcmc/CoupledChains.cpp' || echo '$(srcdir)/'`./src/mcmc/CoupledChains.cpp
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Po
#	$(AM_V_CXX)source='./src/mcmc/CoupledChains.cpp' object='./src/mcmc/libbayes_a-CoupledChains.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/mcmc/libbayes_a-CoupledChains.o `test -f './src/mcmc/CoupledChains.cpp' || echo '$(srcdir)/'`./src/mcmc/CoupledChains.cpp

./src/mcmc/libbayes_a-CoupledChains.obj: ./src/mcmc/CoupledChains.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/mcmc/libbayes_a-CoupledChains.obj -MD -MP -MF ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Tpo -c -o ./src/mcmc/libbayes_a-CoupledChains.obj `if test -f './src/mcmc/CoupledChains.cpp'; then $(CYGPATH_W) './src/mcmc/CoupledChains.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/mcmc/CoupledChains.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-CoupledChains.Po
#	$(AM_V_CXX)source='./src/mcmc/CoupledChains.cpp' object='./src/mcmc/libbayes_a-CoupledChains.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/mcmc/libbayes_a-CoupledChains.obj `if test -f './src/mcmc/CoupledChains.cpp'; then $(CYGPATH_W) './src/mcmc/CoupledChains.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/mcmc/CoupledChains.cpp'; fi`

./src/mcmc/libbayes_a-SampleMaster.o: ./src/mcmc/SampleMaster.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/mcmc/libbayes_a-SampleMaster.o -MD -MP -MF ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Tpo -c -o ./src/mcmc/libbayes_a-SampleMaster.o `test -f './src/mcmc/SampleMaster.cpp' || echo '$(srcdir)/'`./src/mcmc/SampleMaster.cpp
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Po
#	$(AM_V_CXX)source='./src/mcmc/SampleMaster.cpp' object='./src/mcmc/libbayes_a-SampleMaster.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/mcmc/libbayes_a-SampleMaster.o `test -f './src/mcmc/SampleMaster.cpp' || echo '$(srcdir)/'`./src/mcmc/SampleMaster.cpp

./src/mcmc/libbayes_a-SampleMaster.obj: ./src/mcmc/SampleMaster.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/mcmc/libbayes_a-SampleMaster.obj -MD -MP -MF ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Tpo -c -o ./src/mcmc/libbayes_a-SampleMaster.obj `if test -f './src/mcmc/SampleMaster.cpp'; then $(CYGPATH_W) './src/mcmc/SampleMaster.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/mcmc/SampleMaster.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-SampleMaster.Po
#	$(AM_V_CXX)source='./src/mcmc/SampleMaster.cpp' object='./src/mcmc/libbayes_a-SampleMaster.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/mcmc/SuccessCounter.cpp' object='./src/mcmc/libbayes_a-SuccessCounter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/mcmc/libbayes_a-SuccessCounter.o `test -f './src/mcmc/SuccessCounter.cpp' || echo '$(srcdir)/'`./src/mcmc/SuccessCounter.cpp

./src/mcmc/libbayes_a-SuccessCounter.obj: ./src/mcmc/SuccessCounter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/mcmc/libbayes_a-SuccessCounter.obj -MD -MP -MF ./src/mcmc/$(DEPDIR)/libbayes_a-SuccessCounter.Tpo -c -o ./src/mcmc/libbayes_a-SuccessCounter.obj `if test -f './src/mcmc/SuccessCounter.cpp'; then $(CYGPATH_W) './src/mcmc/SuccessCounter.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/mcmc/SuccessCounter.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/mcmc/$(DEPDIR)/libbayes_a-SuccessCounter.Tpo ./src/mcmc/$(DEPDIR)/libbayes_a-SuccessCounter.Po
#	$(AM_V_CXX)source='./src/mcmc/SuccessCounter.cpp' object='./src/mcmc/libbayes_a-SuccessCounter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/model/libbayes_a-Branch.o: ./src/model/Branch.cpp
	...
	$(AM_V_at)$(am__mv) ./src/model/$(DEPDIR)/libbayes_a-Branch.Tpo ./src/model/$(DEPDIR)/libbayes_a-Branch.Po
#	$(AM_V_CXX)source='./src/model/Branch.cpp' object='./src/model/libbayes_a-Branch.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/model/libbayes_a-Branch.o `test -f './src/model/Branch.cpp' || echo '$(srcdir)/'`./src/model/Branch.cpp

./src/model/libbayes_a-Branch.obj: ./src/model/Branch.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/model/libbayes_a-Branch.obj -MD -MP -MF ./src/model/$(DEPDIR)/libbayes_a-Branch.Tpo -c -o ./src/model/libbayes_a-Branch.obj `if test -f './src/model/Branch.cpp'; then $(CYGPATH_W) './src/model/Branch.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/model/Branch.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/model/$(DEPDIR)/libbayes_a-Branch.Tpo ./src/model/$(DEPDIR)/libbayes_a-Branch.Po
#	$(AM_V_CXX)source='./src/model/Branch.cpp' object='./src/model/libbayes_a-Branch.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/model/BranchLengthResource.cpp' object='./src/model/libbayes_a-BranchLengthResource.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/model/libbayes_a-BranchLengthResource.o `test -f './src/model/BranchLengthResource.cpp' || echo '$(srcdir)/'`./src/model/BranchLengthResource.cpp

./src/model/libbayes_a-BranchLengthResource.obj: ./src/model/BranchLengthResource.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/model/libbayes_a-BranchLengthResource.obj -MD -MP -MF ./src/model/$(DEPDIR)/libbayes_a-BranchLengthResource.Tpo -c -o ./src/model/libbayes_a-BranchLengthResource.obj `if test -f './src/model/BranchLengthResource.cpp'; then $(CYGPATH_W) './src/model/BranchLengthResource.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/model/BranchLengthResource.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/model/$(DEPDIR)/libbayes_a-BranchLengthResource.Tpo ./src/model/$(DEPDIR)/libbayes_a-BranchLengthResource.Po
...
./src/model/libbayes_a-Category.o: ./src/model/Category.cpp
	...
	$(AM_V_at)$(am__mv) ./src/model/$(DEPDIR)/libbayes_a-Category.Tpo ./src/model/$(DEPDIR)/libbayes_a-Category.Po
#	$(AM_V_CXX)source='./src/model/Category.cpp' object='./src/model/libbayes_a-Category.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/model/libbayes_a-Category.o `test -f './src/model/Category.cpp' || echo '$(srcdir)/'`./src/model/Category.cpp

./src/model/libbayes_a-Category.obj: ./src/model/Category.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/model/libbayes_a-Category.obj -MD -MP -MF ./src/model/$(DEPDIR)/libbayes_a-Category.Tpo -c -o ./src/model/libbayes_a-Category.obj `if test -f './src/model/Category.cpp'; then $(CYGPATH_W) './src/model/Category.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/model/Category.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/model/$(DEPDIR)/libbayes_a-Category.Tpo ./src/model/$(DEPDIR)/libbayes_a-Category.Po
#	$(AM_V_CXX)source='./src/model/Category.cpp' object='./src/model/libbayes_a-Category.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/system/libbayes_a-BandWidthTest.o: ./src/system/BandWidthTest.cpp
	...
	$(AM_V_at)$(am__mv) ./src/system/$(DEPDIR)/libbayes_a-BandWidthTest.Tpo ./src/system/$(DEPDIR)/libbayes_a-BandWidthTest.Po
#	$(AM_V_CXX)source='./src/system/BandWidthTest.cpp' object='./src/system/libbayes_a-BandWidthTest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/system/libbayes_a-BandWidthTest.o `test -f './src/system/BandWidthTest.cpp' || echo '$(srcdir)/'`./src/system/BandWidthTest.cpp

./src/system/libbayes_a-BandWidthTest.obj: ./src/system/BandWidthTest.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/system/libbayes_a-BandWidthTest.obj -MD -MP -MF ./src/system/$(DEPDIR)/libbayes_a-BandWidthTest.Tpo -c -o ./src/system/libbayes_a-BandWidthTest.obj `if test -f './src/system/BandWidthTest.cpp'; then $(CYGPATH_W) './src/system/BandWidthTest.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/system/BandWidthTest.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/system/$(DEPDIR)/libbayes_a-BandWidthTest.Tpo ./src/system/$(DEPDIR)/libbayes_a-BandWidthTest.Po
#	$(AM_V_CXX)source='./src/system/BandWidthTest.cpp' object='./src/system/libbayes_a-BandWidthTest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/system/BitMask.cpp' object='./src/system/libbayes_a-BitMask.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/system/libbayes_a-BitMask.o `test -f './src/system/BitMask.cpp' || echo '$(srcdir)/'`./src/system/BitMask.cpp

./src/system/libbayes_a-BitMask.obj: ./src/system/BitMask.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/system/libbayes_a-BitMask.obj -MD -MP -MF ./src/system/$(DEPDIR)/libbayes_a-BitMask.Tpo -c -o ./src/system/libbayes_a-BitMask.obj `if test -f './src/system/BitMask.cpp'; then $(CYGPATH_W) './src/system/BitMask.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/system/BitMask.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/system/$(DEPDIR)/libbayes_a-BitMask.Tpo ./src/system/$(DEPDIR)/libbayes_a-BitMask.Po
...
./src/system/libbayes_a-ProposalRegistry.o: ./src/system/ProposalRegistry.cpp
	...
	$(AM_V_at)$(am__mv) ./src/system/$(DEPDIR)/libbayes_a-ProposalRegistry.Tpo ./src/system/$(DEPDIR)/libbayes_a-ProposalRegistry.Po
#	$(AM_V_CXX)source='./src/system/ProposalRegistry.cpp' object='./src/system/libbayes_a-ProposalRegistry.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/system/libbayes_a-ProposalRegistry.o `test -f './src/system/ProposalRegistry.cpp' || echo '$(srcdir)/'`./src/system/ProposalRegistry.cpp

./src/system/libbayes_a-ProposalRegistry.obj: ./src/system/ProposalRegistry.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/system/libbayes_a-ProposalRegistry.obj -MD -MP -MF ./src/system/$(DEPDIR)/libbayes_a-ProposalRegistry.Tpo -c -o ./src/system/libbayes_a-ProposalRegistry.obj `if test -f './src/system/ProposalRegistry.cpp'; then $(CYGPATH_W) './src/system/ProposalRegistry.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/system/ProposalRegistry.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/system/$(DEPDIR)/libbayes_a-ProposalRegistry.Tpo ./src/system/$(DEPDIR)/libbayes_a-ProposalRegistry.Po
#	$(AM_V_CXX)source='./src/system/ProposalRegistry.cpp' object='./src/system/libbayes_a-ProposalRegistry.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/system/Teebuf.cpp' object='./src/system/libbayes_a-Teebuf.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/system/libbayes_a-Teebuf.o `test -f './src/system/Teebuf.cpp' || echo '$(srcdir)/'`./src/system/Teebuf.cpp

./src/system/libbayes_a-Teebuf.obj: ./src/system/Teebuf.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/system/libbayes_a-Teebuf.obj -MD -MP -MF ./src/system/$(DEPDIR)/libbayes_a-Teebuf.Tpo -c -o ./src/system/libbayes_a-Teebuf.obj `if test -f './src/system/Teebuf.cpp'; then $(CYGPATH_W) './src/system/Teebuf.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/system/Teebuf.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/system/$(DEPDIR)/libbayes_a-Teebuf.Tpo ./src/system/$(DEPDIR)/libbayes_a-Teebuf.Po
#	$(AM_V_CXX)source='./src/system/Teebuf.cpp' object='./src/system/libbayes_a-Teebuf.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/data-struct/libbayes_a-BipartitionHash.o: ./src/data-struct/BipartitionHash.cpp
	...
	$(AM_V_at)$(am__mv) ./src/data-struct/$(DEPDIR)/libbayes_a-BipartitionHash.Tpo ./src/data-struct/$(DEPDIR)/libbayes_a-BipartitionHash.Po
#	$(AM_V_CXX)source='./src/data-struct/BipartitionHash.cpp' object='./src/data-struct/libbayes_a-BipartitionHash.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/data-struct/libbayes_a-BipartitionHash.o `test -f './src/data-struct/BipartitionHash.cpp' || echo '$(srcdir)/'`./src/data-struct/BipartitionHash.cpp

./src/data-struct/libbayes_a-BipartitionHash.obj: ./src/data-struct/BipartitionHash.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/data-struct/libbayes_a-BipartitionHash.obj -MD -MP -MF ./src/data-struct/$(DEPDIR)/libbayes_a-BipartitionHash.Tpo -c -o ./src/data-struct/libbayes_a-BipartitionHash.obj `if test -f './src/data-struct/BipartitionHash.cpp'; then $(CYGPATH_W) './src/data-struct/BipartitionHash.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/data-struct/BipartitionHash.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/data-struct/$(DEPDIR)/libbayes_a-BipartitionHash.Tpo ./src/data-struct/$(DEPDIR)/libbayes_a-BipartitionHash.Po
#	$(AM_V_CXX)source='./src/data-struct/BipartitionHash.cpp' object='./src/data-struct/libbayes_a-BipartitionHash.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/data-struct/libbayes_a-BipartitionHash.obj `if test -f './src/data-struct/BipartitionHash.cpp'; then $(CYGPATH_W) './src/data-struct/BipartitionHash.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/data-struct/BipartitionHash.cpp'; fi`

./src/data-struct/libbayes_a-Path.o: ./src/data-struct/Path.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/data-struct/libbayes_a-Path.o -MD -MP -MF ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Tpo -c -o ./src/data-struct/libbayes_a-Path.o `test -f './src/data-struct/Path.cpp' || echo '$(srcdir)/'`./src/data-struct/Path.cpp
	$(AM_V_at)$(am__mv) ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Tpo ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Po
#	$(AM_V_CXX)source='./src/data-struct/Path.cpp' object='./src/data-struct/libbayes_a-Path.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/data-struct/libbayes_a-Path.o `test -f './src/data-struct/Path.cpp' || echo '$(srcdir)/'`./src/data-struct/Path.cpp

./src/data-struct/libbayes_a-Path.obj: ./src/data-struct/Path.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/data-struct/libbayes_a-Path.obj -MD -MP -MF ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Tpo -c -o ./src/data-struct/libbayes_a-Path.obj `if test -f './src/data-struct/Path.cpp'; then $(CYGPATH_W) './src/data-struct/Path.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/data-struct/Path.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Tpo ./src/data-struct/$(DEPDIR)/libbayes_a-Path.Po
#	$(AM_V_CXX)source='./src/data-struct/Path.cpp' object='./src/data-struct/libbayes_a-Path.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/math/libbayes_a-brent.o: ./src/math/brent.cpp
	...
	$(AM_V_at)$(am__mv) ./src/math/$(DEPDIR)/libbayes_a-brent.Tpo ./src/math/$(DEPDIR)/libbayes_a-brent.Po
#	$(AM_V_CXX)source='./src/math/brent.cpp' object='./src/math/libbayes_a-brent.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/math/libbayes_a-brent.o `test -f './src/math/brent.cpp' || echo '$(srcdir)/'`./src/math/brent.cpp

./src/math/libbayes_a-brent.obj: ./src/math/brent.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/math/libbayes_a-brent.obj -MD -MP -MF ./src/math/$(DEPDIR)/libbayes_a-brent.Tpo -c -o ./src/math/libbayes_a-brent.obj `if test -f './src/math/brent.cpp'; then $(CYGPATH_W) './src/math/brent.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/math/brent.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/math/$(DEPDIR)/libbayes_a-brent.Tpo ./src/math/$(DEPDIR)/libbayes_a-brent.Po
#	$(AM_V_CXX)source='./src/math/brent.cpp' object='./src/math/libbayes_a-brent.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/math/libbayes_a-Randomness.o: ./src/math/Randomness.cpp
	...
	$(AM_V_at)$(am__mv) ./src/math/$(DEPDIR)/libbayes_a-Randomness.Tpo ./src/math/$(DEPDIR)/libbayes_a-Randomness.Po
#	$(AM_V_CXX)source='./src/math/Randomness.cpp' object='./src/math/libbayes_a-Randomness.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/math/libbayes_a-Randomness.o `test -f './src/math/Randomness.cpp' || echo '$(srcdir)/'`./src/math/Randomness.cpp

./src/math/libbayes_a-Randomness.obj: ./src/math/Randomness.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbayes_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/math/libbayes_a-Randomness.obj -MD -MP -MF ./src/math/$(DEPDIR)/libbayes_a-Randomness.Tpo -c -o ./src/math/libbayes_a-Randomness.obj `if test -f './src/math/Randomness.cpp'; then $(CYGPATH_W) './src/math/Randomness.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/math/Randomness.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/math/$(DEPDIR)/libbayes_a-Randomness.Tpo ./src/math/$(DEPDIR)/libbayes_a-Randomness.Po
#	$(AM_V_CXX)source='./src/math/Randomness.cpp' object='./src/math/libbayes_a-Randomness.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/comm/libcommdummy_a-Communicator.o: ./src/comm/Communicator.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommdummy_a-Communicator.Tpo ./src/comm/$(DEPDIR)/libcommdummy_a-Communicator.Po
#	$(AM_V_CXX)source='./src/comm/Communicator.cpp' object='./src/comm/libcommdummy_a-Communicator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommdummy_a-Communicator.o `test -f './src/comm/Communicator.cpp' || echo '$(srcdir)/'`./src/comm/Communicator.cpp

./src/comm/libcommdummy_a-Communicator.obj: ./src/comm/Communicator.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommdummy_a-Communicator.obj -MD -MP -MF ./src/comm/$(DEPDIR)/libcommdummy_a-Communicator.Tpo -c -o ./src/comm/libcommdummy_a-Communicator.obj `if test -f './src/comm/Communicator.cpp'; then $(CYGPATH_W) './src/comm/Communicator.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/Communicator.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommdummy_a-Communicator.Tpo ./src/comm/$(DEPDIR)/libcommdummy_a-Communicator.Po
#	$(AM_V_CXX)source='./src/comm/Communicator.cpp' object='./src/comm/libcommdummy_a-Communicator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/comm/libcommdummy_a-LocalComm.o: ./src/comm/LocalComm.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommdummy_a-LocalComm.Tpo ./src/comm/$(DEPDIR)/libcommdummy_a-LocalComm.Po
#	$(AM_V_CXX)source='./src/comm/LocalComm.cpp' object='./src/comm/libcommdummy_a-LocalComm.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommdummy_a-LocalComm.o `test -f './src/comm/LocalComm.cpp' || echo '$(srcdir)/'`./src/comm/LocalComm.cpp

./src/comm/libcommdummy_a-LocalComm.obj: ./src/comm/LocalComm.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommdummy_a-LocalComm.obj -MD -MP -MF ./src/comm/$(DEPDIR)/libcommdummy_a-LocalComm.Tpo -c -o ./src/comm/libcommdummy_a-LocalComm.obj `if test -f './src/comm/LocalComm.cpp'; then $(CYGPATH_W) './src/comm/LocalComm.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/LocalComm.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommdummy_a-LocalComm.Tpo ./src/comm/$(DEPDIR)/libcommdummy_a-LocalComm.Po
#	$(AM_V_CXX)source='./src/comm/LocalComm.cpp' object='./src/comm/libcommdummy_a-LocalComm.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommdummy_a-LocalComm.obj `if test -f './src/comm/LocalComm.cpp'; then $(CYGPATH_W) './src/comm/LocalComm.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/LocalComm.cpp'; fi`

./src/comm/libcommdummy_a-LocalSwap.o: ./src/comm/LocalSwap.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommdummy_a-LocalSwap.o -MD -MP -MF ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Tpo -c -o ./src/comm/libcommdummy_a-LocalSwap.o `test -f './src/comm/LocalSwap.cpp' || echo '$(srcdir)/'`./src/comm/LocalSwap.cpp
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Tpo ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Po
#	$(AM_V_CXX)source='./src/comm/LocalSwap.cpp' object='./src/comm/libcommdummy_a-LocalSwap.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommdummy_a-LocalSwap.o `test -f './src/comm/LocalSwap.cpp' || echo '$(srcdir)/'`./src/comm/LocalSwap.cpp

./src/comm/libcommdummy_a-LocalSwap.obj: ./src/comm/LocalSwap.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommdummy_a-LocalSwap.obj -MD -MP -MF ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Tpo -c -o ./src/comm/libcommdummy_a-LocalSwap.obj `if test -f './src/comm/LocalSwap.cpp'; then $(CYGPATH_W) './src/comm/LocalSwap.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/LocalSwap.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Tpo ./src/comm/$(DEPDIR)/libcommdummy_a-LocalSwap.Po
...
./src/comm/dummy/libcommdummy_a-CommRequestImpl.o: ./src/comm/dummy/CommRequestImpl.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-CommRequestImpl.Tpo ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-CommRequestImpl.Po
#	$(AM_V_CXX)source='./src/comm/dummy/CommRequestImpl.cpp' object='./src/comm/dummy/libcommdummy_a-CommRequestImpl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/dummy/libcommdummy_a-CommRequestImpl.o `test -f './src/comm/dummy/CommRequestImpl.cpp' || echo '$(srcdir)/'`./src/comm/dummy/CommRequestImpl.cpp

./src/comm/dummy/libcommdummy_a-CommRequestImpl.obj: ./src/comm/dummy/CommRequestImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/dummy/libcommdummy_a-CommRequestImpl.obj -MD -MP -MF ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-CommRequestImpl.Tpo -c -o ./src/comm/dummy/libcommdummy_a-CommRequestImpl.obj `if test -f './src/comm/dummy/CommRequestImpl.cpp'; then $(CYGPATH_W) './src/comm/dummy/CommRequestImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/dummy/CommRequestImpl.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-CommRequestImpl.Tpo ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-CommRequestImpl.Po
#	$(AM_V_CXX)source='./src/comm/dummy/CommRequestImpl.cpp' object='./src/comm/dummy/libcommdummy_a-CommRequestImpl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/dummy/libcommdummy_a-CommRequestImpl.obj `if test -f './src/comm/dummy/CommRequestImpl.cpp'; then $(CYGPATH_W) './src/comm/dummy/CommRequestImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/dummy/CommRequestImpl.cpp'; fi`

./src/comm/dummy/libcommdummy_a-PendingSwapImpl.o: ./src/comm/dummy/PendingSwapImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/dummy/libcommdummy_a-PendingSwapImpl.o -MD -MP -MF ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Tpo -c -o ./src/comm/dummy/libcommdummy_a-PendingSwapImpl.o `test -f './src/comm/dummy/PendingSwapImpl.cpp' || echo '$(srcdir)/'`./src/comm/dummy/PendingSwapImpl.cpp
	$(AM_V_at)$(am__mv) ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Tpo ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Po
#	$(AM_V_CXX)source='./src/comm/dummy/PendingSwapImpl.cpp' object='./src/comm/dummy/libcommdummy_a-PendingSwapImpl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/dummy/libcommdummy_a-PendingSwapImpl.o `test -f './src/comm/dummy/PendingSwapImpl.cpp' || echo '$(srcdir)/'`./src/comm/dummy/PendingSwapImpl.cpp

./src/comm/dummy/libcommdummy_a-PendingSwapImpl.obj: ./src/comm/dummy/PendingSwapImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/dummy/libcommdummy_a-PendingSwapImpl.obj -MD -MP -MF ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Tpo -c -o ./src/comm/dummy/libcommdummy_a-PendingSwapImpl.obj `if test -f './src/comm/dummy/PendingSwapImpl.cpp'; then $(CYGPATH_W) './src/comm/dummy/PendingSwapImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/dummy/PendingSwapImpl.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Tpo ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-PendingSwapImpl.Po
#	$(AM_V_CXX)source='./src/comm/dummy/PendingSwapImpl.cpp' object='./src/comm/dummy/libcommdummy_a-PendingSwapImpl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/dummy/libcommdummy_a-PendingSwapImpl.obj `if test -f './src/comm/dummy/PendingSwapImpl.cpp'; then $(CYGPATH_W) './src/comm/dummy/PendingSwapImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/dummy/PendingSwapImpl.cpp'; fi`

./src/comm/dummy/libcommdummy_a-RemoteCommImpl.o: ./src/comm/dummy/RemoteCommImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/dummy/libcommdummy_a-RemoteCommImpl.o -MD -MP -MF ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Tpo -c -o ./src/comm/dummy/libcommdummy_a-RemoteCommImpl.o `test -f './src/comm/dummy/RemoteCommImpl.cpp' || echo '$(srcdir)/'`./src/comm/dummy/RemoteCommImpl.cpp
	$(AM_V_at)$(am__mv) ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Tpo ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Po
#	$(AM_V_CXX)source='./src/comm/dummy/RemoteCommImpl.cpp' object='./src/comm/dummy/libcommdummy_a-RemoteCommImpl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/dummy/libcommdummy_a-RemoteCommImpl.o `test -f './src/comm/dummy/RemoteCommImpl.cpp' || echo '$(srcdir)/'`./src/comm/dummy/RemoteCommImpl.cpp

./src/comm/dummy/libcommdummy_a-RemoteCommImpl.obj: ./src/comm/dummy/RemoteCommImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/dummy/libcommdummy_a-RemoteCommImpl.obj -MD -MP -MF ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Tpo -c -o ./src/comm/dummy/libcommdummy_a-RemoteCommImpl.obj `if test -f './src/comm/dummy/RemoteCommImpl.cpp'; then $(CYGPATH_W) './src/comm/dummy/RemoteCommImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/dummy/RemoteCommImpl.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Tpo ./src/comm/dummy/$(DEPDIR)/libcommdummy_a-RemoteCommImpl.Po
#	$(AM_V_CXX)source='./src/comm/dummy/RemoteCommImpl.cpp' object='./src/comm/dummy/libcommdummy_a-RemoteCommImpl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='./src/comm/threads/MessageQueueSingle.cpp' object='./src/comm/threads/libcommdummy_a-MessageQueueSingle.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommdummy_a-MessageQueueSingle.o `test -f './src/comm/threads/MessageQueueSingle.cpp' || echo '$(srcdir)/'`./src/comm/threads/MessageQueueSingle.cpp

./src/comm/threads/libcommdummy_a-MessageQueueSingle.obj: ./src/comm/threads/MessageQueueSingle.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/threads/libcommdummy_a-MessageQueueSingle.obj -MD -MP -MF ./src/comm/threads/$(DEPDIR)/libcommdummy_a-MessageQueueSingle.Tpo -c -o ./src/comm/threads/libcommdummy_a-MessageQueueSingle.obj `if test -f './src/comm/threads/MessageQueueSingle.cpp'; then $(CYGPATH_W) './src/comm/threads/MessageQueueSingle.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/MessageQueueSingle.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommdummy_a-MessageQueueSingle.Tpo ./src/comm/threads/$(DEPDIR)/libcommdummy_a-MessageQueueSingle.Po
#	$(AM_V_CXX)source='./src/comm/threads/MessageQueueSingle.cpp' object='./src/comm/threads/libcommdummy_a-MessageQueueSingle.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommdummy_a-MessageQueueSingle.obj `if test -f './src/comm/threads/MessageQueueSingle.cpp'; then $(CYGPATH_W) './src/comm/threads/MessageQueueSingle.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/MessageQueueSingle.cpp'; fi`

./src/comm/threads/libcommdummy_a-ThreadResource.o: ./src/comm/threads/ThreadResource.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/threads/libcommdummy_a-ThreadResource.o -MD -MP -MF ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Tpo -c -o ./src/comm/threads/libcommdummy_a-ThreadResource.o `test -f './src/comm/threads/ThreadResource.cpp' || echo '$(srcdir)/'`./src/comm/threads/ThreadResource.cpp
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Tpo ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Po
#	$(AM_V_CXX)source='./src/comm/threads/ThreadResource.cpp' object='./src/comm/threads/libcommdummy_a-ThreadResource.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommdummy_a-ThreadResource.o `test -f './src/comm/threads/ThreadResource.cpp' || echo '$(srcdir)/'`./src/comm/threads/ThreadResource.cpp

./src/comm/threads/libcommdummy_a-ThreadResource.obj: ./src/comm/threads/ThreadResource.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/threads/libcommdummy_a-ThreadResource.obj -MD -MP -MF ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Tpo -c -o ./src/comm/threads/libcommdummy_a-ThreadResource.obj `if test -f './src/comm/threads/ThreadResource.cpp'; then $(CYGPATH_W) './src/comm/threads/ThreadResource.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/ThreadResource.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Tpo ./src/comm/threads/$(DEPDIR)/libcommdummy_a-ThreadResource.Po
#	$(AM_V_CXX)source='./src/comm/threads/ThreadResource.cpp' object='./src/comm/threads/libcommdummy_a-ThreadResource.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommdummy_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommdummy_a-ThreadResource.obj `if test -f './src/comm/threads/ThreadResource.cpp'; then $(CYGPATH_W) './src/comm/threads/ThreadResource.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/ThreadResource.cpp'; fi`
...
./src/comm/threads/libcommmpi_a-MessageQueueSingle.o: ./src/comm/threads/MessageQueueSingle.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueueSingle.Tpo ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueueSingle.Po
#	$(AM_V_CXX)source='./src/comm/threads/MessageQueueSingle.cpp' object='./src/comm/threads/libcommmpi_a-MessageQueueSingle.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommmpi_a-MessageQueueSingle.o `test -f './src/comm/threads/MessageQueueSingle.cpp' || echo '$(srcdir)/'`./src/comm/threads/MessageQueueSingle.cpp

./src/comm/threads/libcommmpi_a-MessageQueueSingle.obj: ./src/comm/threads/MessageQueueSingle.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/threads/libcommmpi_a-MessageQueueSingle.obj -MD -MP -MF ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueueSingle.Tpo -c -o ./src/comm/threads/libcommmpi_a-MessageQueueSingle.obj `if test -f './src/comm/threads/MessageQueueSingle.cpp'; then $(CYGPATH_W) './src/comm/threads/MessageQueueSingle.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/MessageQueueSingle.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueueSingle.Tpo ./src/comm/threads/$(DEPDIR)/libcommmpi_a-MessageQueueSingle.Po
#	$(AM_V_CXX)source='./src/comm/threads/MessageQueueSingle.cpp' object='./src/comm/threads/libcommmpi_a-MessageQueueSingle.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommmpi_a-MessageQueueSingle.obj `if test -f './src/comm/threads/MessageQueueSingle.cpp'; then $(CYGPATH_W) './src/comm/threads/MessageQueueSingle.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/MessageQueueSingle.cpp'; fi`

./src/comm/threads/libcommmpi_a-ThreadResource.o: ./src/comm/threads/ThreadResource.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/threads/libcommmpi_a-ThreadResource.o -MD -MP -MF ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Tpo -c -o ./src/comm/threads/libcommmpi_a-ThreadResource.o `test -f './src/comm/threads/ThreadResource.cpp' || echo '$(srcdir)/'`./src/comm/threads/ThreadResource.cpp
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Tpo ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Po
#	$(AM_V_CXX)source='./src/comm/threads/ThreadResource.cpp' object='./src/comm/threads/libcommmpi_a-ThreadResource.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommmpi_a-ThreadResource.o `test -f './src/comm/threads/ThreadResource.cpp' || echo '$(srcdir)/'`./src/comm/threads/ThreadResource.cpp

./src/comm/threads/libcommmpi_a-ThreadResource.obj: ./src/comm/threads/ThreadResource.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/threads/libcommmpi_a-ThreadResource.obj -MD -MP -MF ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Tpo -c -o ./src/comm/threads/libcommmpi_a-ThreadResource.obj `if test -f './src/comm/threads/ThreadResource.cpp'; then $(CYGPATH_W) './src/comm/threads/ThreadResource.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/ThreadResource.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Tpo ./src/comm/threads/$(DEPDIR)/libcommmpi_a-ThreadResource.Po
#	$(AM_V_CXX)source='./src/comm/threads/ThreadResource.cpp' object='./src/comm/threads/libcommmpi_a-ThreadResource.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/threads/libcommmpi_a-ThreadResource.obj `if test -f './src/comm/threads/ThreadResource.cpp'; then $(CYGPATH_W) './src/comm/threads/ThreadResource.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/threads/ThreadResource.cpp'; fi`
...
./src/comm/mpi/libcommmpi_a-MpiType.o: ./src/comm/mpi/MpiType.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-MpiType.Tpo ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-MpiType.Po
#	$(AM_V_CXX)source='./src/comm/mpi/MpiType.cpp' object='./src/comm/mpi/libcommmpi_a-MpiType.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/mpi/libcommmpi_a-MpiType.o `test -f './src/comm/mpi/MpiType.cpp' || echo '$(srcdir)/'`./src/comm/mpi/MpiType.cpp

./src/comm/mpi/libcommmpi_a-MpiType.obj: ./src/comm/mpi/MpiType.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/mpi/libcommmpi_a-MpiType.obj -MD -MP -MF ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-MpiType.Tpo -c -o ./src/comm/mpi/libcommmpi_a-MpiType.obj `if test -f './src/comm/mpi/MpiType.cpp'; then $(CYGPATH_W) './src/comm/mpi/MpiType.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/mpi/MpiType.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-MpiType.Tpo ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-MpiType.Po
...
./src/comm/mpi/libcommmpi_a-PendingSwapImpl.o: ./src/comm/mpi/PendingSwapImpl.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-PendingSwapImpl.Tpo ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-PendingSwapImpl.Po
#	$(AM_V_CXX)source='./src/comm/mpi/PendingSwapImpl.cpp' object='./src/comm/mpi/libcommmpi_a-PendingSwapImpl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/mpi/libcommmpi_a-PendingSwapImpl.o `test -f './src/comm/mpi/PendingSwapImpl.cpp' || echo '$(srcdir)/'`./src/comm/mpi/PendingSwapImpl.cpp

./src/comm/mpi/libcommmpi_a-PendingSwapImpl.obj: ./src/comm/mpi/PendingSwapImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/mpi/libcommmpi_a-PendingSwapImpl.obj -MD -MP -MF ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-PendingSwapImpl.Tpo -c -o ./src/comm/mpi/libcommmpi_a-PendingSwapImpl.obj `if test -f './src/comm/mpi/PendingSwapImpl.cpp'; then $(CYGPATH_W) './src/comm/mpi/PendingSwapImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/mpi/PendingSwapImpl.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-PendingSwapImpl.Tpo ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-PendingSwapImpl.Po
#	$(AM_V_CXX)source='./src/comm/mpi/PendingSwapImpl.cpp' object='./src/comm/mpi/libcommmpi_a-PendingSwapImpl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/mpi/libcommmpi_a-PendingSwapImpl.obj `if test -f './src/comm/mpi/PendingSwapImpl.cpp'; then $(CYGPATH_W) './src/comm/mpi/PendingSwapImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/mpi/PendingSwapImpl.cpp'; fi`

./src/comm/mpi/libcommmpi_a-RemoteCommImpl.o: ./src/comm/mpi/RemoteCommImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/mpi/libcommmpi_a-RemoteCommImpl.o -MD -MP -MF ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Tpo -c -o ./src/comm/mpi/libcommmpi_a-RemoteCommImpl.o `test -f './src/comm/mpi/RemoteCommImpl.cpp' || echo '$(srcdir)/'`./src/comm/mpi/RemoteCommImpl.cpp
	$(AM_V_at)$(am__mv) ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Tpo ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Po
#	$(AM_V_CXX)source='./src/comm/mpi/RemoteCommImpl.cpp' object='./src/comm/mpi/libcommmpi_a-RemoteCommImpl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/mpi/libcommmpi_a-RemoteCommImpl.o `test -f './src/comm/mpi/RemoteCommImpl.cpp' || echo '$(srcdir)/'`./src/comm/mpi/RemoteCommImpl.cpp

./src/comm/mpi/libcommmpi_a-RemoteCommImpl.obj: ./src/comm/mpi/RemoteCommImpl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/mpi/libcommmpi_a-RemoteCommImpl.obj -MD -MP -MF ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Tpo -c -o ./src/comm/mpi/libcommmpi_a-RemoteCommImpl.obj `if test -f './src/comm/mpi/RemoteCommImpl.cpp'; then $(CYGPATH_W) './src/comm/mpi/RemoteCommImpl.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/mpi/RemoteCommImpl.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Tpo ./src/comm/mpi/$(DEPDIR)/libcommmpi_a-RemoteCommImpl.Po
#	$(AM_V_CXX)source='./src/comm/mpi/RemoteCommImpl.cpp' object='./src/comm/mpi/libcommmpi_a-RemoteCommImpl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/comm/libcommmpi_a-Communicator.o: ./src/comm/Communicator.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommmpi_a-Communicator.Tpo ./src/comm/$(DEPDIR)/libcommmpi_a-Communicator.Po
#	$(AM_V_CXX)source='./src/comm/Communicator.cpp' object='./src/comm/libcommmpi_a-Communicator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommmpi_a-Communicator.o `test -f './src/comm/Communicator.cpp' || echo '$(srcdir)/'`./src/comm/Communicator.cpp

./src/comm/libcommmpi_a-Communicator.obj: ./src/comm/Communicator.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommmpi_a-Communicator.obj -MD -MP -MF ./src/comm/$(DEPDIR)/libcommmpi_a-Communicator.Tpo -c -o ./src/comm/libcommmpi_a-Communicator.obj `if test -f './src/comm/Communicator.cpp'; then $(CYGPATH_W) './src/comm/Communicator.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/Communicator.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommmpi_a-Communicator.Tpo ./src/comm/$(DEPDIR)/libcommmpi_a-Communicator.Po
#	$(AM_V_CXX)source='./src/comm/Communicator.cpp' object='./src/comm/libcommmpi_a-Communicator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./src/comm/libcommmpi_a-LocalComm.o: ./src/comm/LocalComm.cpp
	...
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommmpi_a-LocalComm.Tpo ./src/comm/$(DEPDIR)/libcommmpi_a-LocalComm.Po
#	$(AM_V_CXX)source='./src/comm/LocalComm.cpp' object='./src/comm/libcommmpi_a-LocalComm.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommmpi_a-LocalComm.o `test -f './src/comm/LocalComm.cpp' || echo '$(srcdir)/'`./src/comm/LocalComm.cpp

./src/comm/libcommmpi_a-LocalComm.obj: ./src/comm/LocalComm.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommmpi_a-LocalComm.obj -MD -MP -MF ./src/comm/$(DEPDIR)/libcommmpi_a-LocalComm.Tpo -c -o ./src/comm/libcommmpi_a-LocalComm.obj `if test -f './src/comm/LocalComm.cpp'; then $(CYGPATH_W) './src/comm/LocalComm.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/LocalComm.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommmpi_a-LocalComm.Tpo ./src/comm/$(DEPDIR)/libcommmpi_a-LocalComm.Po
#	$(AM_V_CXX)source='./src/comm/LocalComm.cpp' object='./src/comm/libcommmpi_a-LocalComm.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommmpi_a-LocalComm.obj `if test -f './src/comm/LocalComm.cpp'; then $(CYGPATH_W) './src/comm/LocalComm.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/LocalComm.cpp'; fi`

./src/comm/libcommmpi_a-LocalSwap.o: ./src/comm/LocalSwap.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommmpi_a-LocalSwap.o -MD -MP -MF ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Tpo -c -o ./src/comm/libcommmpi_a-LocalSwap.o `test -f './src/comm/LocalSwap.cpp' || echo '$(srcdir)/'`./src/comm/LocalSwap.cpp
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Tpo ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Po
#	$(AM_V_CXX)source='./src/comm/LocalSwap.cpp' object='./src/comm/libcommmpi_a-LocalSwap.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -c -o ./src/comm/libcommmpi_a-LocalSwap.o `test -f './src/comm/LocalSwap.cpp' || echo '$(srcdir)/'`./src/comm/LocalSwap.cpp

./src/comm/libcommmpi_a-LocalSwap.obj: ./src/comm/LocalSwap.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libcommmpi_a_CXXFLAGS) $(CXXFLAGS) -MT ./src/comm/libcommmpi_a-LocalSwap.obj -MD -MP -MF ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Tpo -c -o ./src/comm/libcommmpi_a-LocalSwap.obj `if test -f './src/comm/LocalSwap.cpp'; then $(CYGPATH_W) './src/comm/LocalSwap.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/comm/LocalSwap.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Tpo ./src/comm/$(DEPDIR)/libcommmpi_a-LocalSwap.Po
#	$(AM_V_CXX)source='./src/comm/LocalSwap.cpp' object='./src/comm/libcommmpi_a-LocalSwap.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.o: ./lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp
	...
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsassumptionsblock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsassumptionsblock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.o `test -f './lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.obj: ./lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.obj -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsassumptionsblock.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.obj `if test -f './lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp'; fi`
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsassumptionsblock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsassumptionsblock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxsassumptionsblock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxsassumptionsblock.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.o: ./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp
	...
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscxxdiscretematrix.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscxxdiscretematrix.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.o `test -f './lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.obj: ./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.obj -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscxxdiscretematrix.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.obj `if test -f './lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp'; fi`
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscxxdiscretematrix.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxscxxdiscretematrix.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxscxxdiscretematrix.obj `if test -f './lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxscxxdiscretematrix.cpp'; fi`
...
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxsdistancesblock.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsdistancesblock.o `test -f './lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxsdistancesblock.obj: ./lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxsdistancesblock.obj -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsdistancesblock.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsdistancesblock.obj `if test -f './lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxsdistancesblock.cpp'; fi`
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsdistancesblock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsdistancesblock.Po
...
./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.o: ./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp
	...
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsmultiformat.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsmultiformat.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.o `test -f './lib/ncl-2.1.18/ncl/nxsmultiformat.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.obj: ./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.obj -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsmultiformat.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.obj `if test -f './lib/ncl-2.1.18/ncl/nxsmultiformat.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxsmultiformat.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp'; fi`
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsmultiformat.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsmultiformat.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsmultiformat.obj `if test -f './lib/ncl-2.1.18/ncl/nxsmultiformat.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxsmultiformat.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxsmultiformat.cpp'; fi`
...
./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.o: ./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp
	...
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxaassociationblock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxaassociationblock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.o `test -f './lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.obj: ./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.obj -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxaassociationblock.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.obj `if test -f './lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp'; fi`
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxaassociationblock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxaassociationblock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxaassociationblock.obj `if test -f './lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxstaxaassociationblock.cpp'; fi`

./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.o: ./lib/ncl-2.1.18/ncl/nxstaxablock.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.o -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.o `test -f './lib/ncl-2.1.18/ncl/nxstaxablock.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxstaxablock.cpp
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxstaxablock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.o `test -f './lib/ncl-2.1.18/ncl/nxstaxablock.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxstaxablock.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.obj: ./lib/ncl-2.1.18/ncl/nxstaxablock.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -MT ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.obj -MD -MP -MF ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Tpo -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.obj `if test -f './lib/ncl-2.1.18/ncl/nxstaxablock.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxstaxablock.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxstaxablock.cpp'; fi`
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxstaxablock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxstaxablock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxstaxablock.obj `if test -f './lib/ncl-2.1.18/ncl/nxstaxablock.cpp'; then $(CYGPATH_W) './lib/ncl-2.1.18/ncl/nxstaxablock.cpp'; else $(CYGPATH_W) '$(srcdir)/./lib/ncl-2.1.18/ncl/nxstaxablock.cpp'; fi`
...
./lib/ncl-2.1.18/ncl/libncl_a-nxsunalignedblock.o: ./lib/ncl-2.1.18/ncl/nxsunalignedblock.cpp
	...
	$(AM_V_at)$(am__mv) ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsunalignedblock.Tpo ./lib/ncl-2.1.18/ncl/$(DEPDIR)/libncl_a-nxsunalignedblock.Po
#	$(AM_V_CXX)source='./lib/ncl-2.1.18/ncl/nxsunalignedblock.cpp' object='./lib/ncl-2.1.18/ncl/libncl_a-nxsunalignedblock.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libncl_a_CXXFLAGS) $(CXXFLAGS) -c -o ./lib/ncl-2.1.18/ncl/libncl_a-nxsunalignedblock.o `test -f './lib/ncl-2.1.18/ncl/nxsunalignedblock.cpp' || echo '$(srcdir)/'`./lib/ncl-2.1.18/ncl/nxsunalignedblock.cpp

./lib/ncl-2.1.18/ncl/libncl_a-nxsunalignedblock.obj: ./lib/ncl-2.1.18/ncl/nxsunalignedblock.cpp
...
./src/apps/consense-consense.o: ./src/apps/consense.cpp
	...
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/consense-consense.Tpo ./src/apps/$(DEPDIR)/consense-consense.Po
#	$(AM_V_CXX)source='./src/apps/consense.cpp' object='./src/apps/consense-consense.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(consense_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/consense-consense.o `test -f './src/apps/consense.cpp' || echo '$(srcdir)/'`./src/apps/consense.cpp

./src/apps/consense-consense.obj: ./src/apps/consense.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(consense_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/consense-consense.obj -MD -MP -MF ./src/apps/$(DEPDIR)/consense-consense.Tpo -c -o ./src/apps/consense-consense.obj `if test -f './src/apps/consense.cpp'; then $(CYGPATH_W) './src/apps/consense.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/consense.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/consense-consense.Tpo ./src/apps/$(DEPDIR)/consense-consense.Po
#	$(AM_V_CXX)source='./src/apps/consense.cpp' object='./src/apps/consense-consense.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(consense_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/consense-consense.obj `if test -f './src/apps/consense.cpp'; then $(CYGPATH_W) './src/apps/consense.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/consense.cpp'; fi`

./src/apps/credibleSet-credibleSet.o: ./src/apps/credibleSet.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(credibleSet_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/credibleSet-credibleSet.o -MD -MP -MF ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Tpo -c -o ./src/apps/credibleSet-credibleSet.o `test -f './src/apps/credibleSet.cpp' || echo '$(srcdir)/'`./src/apps/credibleSet.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Tpo ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Po
#	$(AM_V_CXX)source='./src/apps/credibleSet.cpp' object='./src/apps/credibleSet-credibleSet.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(credibleSet_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/credibleSet-credibleSet.o `test -f './src/apps/credibleSet.cpp' || echo '$(srcdir)/'`./src/apps/credibleSet.cpp

./src/apps/credibleSet-credibleSet.obj: ./src/apps/credibleSet.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(credibleSet_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/credibleSet-credibleSet.obj -MD -MP -MF ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Tpo -c -o ./src/apps/credibleSet-credibleSet.obj `if test -f './src/apps/credibleSet.cpp'; then $(CYGPATH_W) './src/apps/credibleSet.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/credibleSet.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Tpo ./src/apps/$(DEPDIR)/credibleSet-credibleSet.Po
#	$(AM_V_CXX)source='./src/apps/credibleSet.cpp' object='./src/apps/credibleSet-credibleSet.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(credibleSet_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/credibleSet-credibleSet.obj `if test -f './src/apps/credibleSet.cpp'; then $(CYGPATH_W) './src/apps/credibleSet.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/credibleSet.cpp'; fi`

./src/apps/exabayes-exabayes.o: ./src/apps/exabayes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exabayes_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/exabayes-exabayes.o -MD -MP -MF ./src/apps/$(DEPDIR)/exabayes-exabayes.Tpo -c -o ./src/apps/exabayes-exabayes.o `test -f './src/apps/exabayes.cpp' || echo '$(srcdir)/'`./src/apps/exabayes.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/exabayes-exabayes.Tpo ./src/apps/$(DEPDIR)/exabayes-exabayes.Po
#	$(AM_V_CXX)source='./src/apps/exabayes.cpp' object='./src/apps/exabayes-exabayes.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exabayes_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/exabayes-exabayes.o `test -f './src/apps/exabayes.cpp' || echo '$(srcdir)/'`./src/apps/exabayes.cpp

./src/apps/exabayes-exabayes.obj: ./src/apps/exabayes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exabayes_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/exabayes-exabayes.obj -MD -MP -MF ./src/apps/$(DEPDIR)/exabayes-exabayes.Tpo -c -o ./src/apps/exabayes-exabayes.obj `if test -f './src/apps/exabayes.cpp'; then $(CYGPATH_W) './src/apps/exabayes.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/exabayes.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/exabayes-exabayes.Tpo ./src/apps/$(DEPDIR)/exabayes-exabayes.Po
#	$(AM_V_CXX)source='./src/apps/exabayes.cpp' object='./src/apps/exabayes-exabayes.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exabayes_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/exabayes-exabayes.obj `if test -f './src/apps/exabayes.cpp'; then $(CYGPATH_W) './src/apps/exabayes.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/exabayes.cpp'; fi`

./tests/exatest-exatest.o: ./tests/exatest.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exatest_CXXFLAGS) $(CXXFLAGS) -MT ./tests/exatest-exatest.o -MD -MP -MF ./tests/$(DEPDIR)/exatest-exatest.Tpo -c -o ./tests/exatest-exatest.o `test -f './tests/exatest.cpp' || echo '$(srcdir)/'`./tests/exatest.cpp
	$(AM_V_at)$(am__mv) ./tests/$(DEPDIR)/exatest-exatest.Tpo ./tests/$(DEPDIR)/exatest-exatest.Po
#	$(AM_V_CXX)source='./tests/exatest.cpp' object='./tests/exatest-exatest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exatest_CXXFLAGS) $(CXXFLAGS) -c -o ./tests/exatest-exatest.o `test -f './tests/exatest.cpp' || echo '$(srcdir)/'`./tests/exatest.cpp

./tests/exatest-exatest.obj: ./tests/exatest.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exatest_CXXFLAGS) $(CXXFLAGS) -MT ./tests/exatest-exatest.obj -MD -MP -MF ./tests/$(DEPDIR)/exatest-exatest.Tpo -c -o ./tests/exatest-exatest.obj `if test -f './tests/exatest.cpp'; then $(CYGPATH_W) './tests/exatest.cpp'; else $(CYGPATH_W) '$(srcdir)/./tests/exatest.cpp'; fi`
	$(AM_V_at)$(am__mv) ./tests/$(DEPDIR)/exatest-exatest.Tpo ./tests/$(DEPDIR)/exatest-exatest.Po
#	$(AM_V_CXX)source='./tests/exatest.cpp' object='./tests/exatest-exatest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(exatest_CXXFLAGS) $(CXXFLAGS) -c -o ./tests/exatest-exatest.obj `if test -f './tests/exatest.cpp'; then $(CYGPATH_W) './tests/exatest.cpp'; else $(CYGPATH_W) '$(srcdir)/./tests/exatest.cpp'; fi`

./src/apps/extractBips-extractBips.o: ./src/apps/extractBips.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(extractBips_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/extractBips-extractBips.o -MD -MP -MF ./src/apps/$(DEPDIR)/extractBips-extractBips.Tpo -c -o ./src/apps/extractBips-extractBips.o `test -f './src/apps/extractBips.cpp' || echo '$(srcdir)/'`./src/apps/extractBips.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/extractBips-extractBips.Tpo ./src/apps/$(DEPDIR)/extractBips-extractBips.Po
#	$(AM_V_CXX)source='./src/apps/extractBips.cpp' object='./src/apps/extractBips-extractBips.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(extractBips_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/extractBips-extractBips.o `test -f './src/apps/extractBips.cpp' || echo '$(srcdir)/'`./src/apps/extractBips.cpp

./src/apps/extractBips-extractBips.obj: ./src/apps/extractBips.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(extractBips_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/extractBips-extractBips.obj -MD -MP -MF ./src/apps/$(DEPDIR)/extractBips-extractBips.Tpo -c -o ./src/apps/extractBips-extractBips.obj `if test -f './src/apps/extractBips.cpp'; then $(CYGPATH_W) './src/apps/extractBips.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/extractBips.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/extractBips-extractBips.Tpo ./src/apps/$(DEPDIR)/extractBips-extractBips.Po
#	$(AM_V_CXX)source='./src/apps/extractBips.cpp' object='./src/apps/extractBips-extractBips.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(extractBips_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/extractBips-extractBips.obj `if test -f './src/apps/extractBips.cpp'; then $(CYGPATH_W) './src/apps/extractBips.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/extractBips.cpp'; fi`

./src/apps/parser-parser.o: ./src/apps/parser.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(parser_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/parser-parser.o -MD -MP -MF ./src/apps/$(DEPDIR)/parser-parser.Tpo -c -o ./src/apps/parser-parser.o `test -f './src/apps/parser.cpp' || echo '$(srcdir)/'`./src/apps/parser.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/parser-parser.Tpo ./src/apps/$(DEPDIR)/parser-parser.Po
#	$(AM_V_CXX)source='./src/apps/parser.cpp' object='./src/apps/parser-parser.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(parser_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/parser-parser.o `test -f './src/apps/parser.cpp' || echo '$(srcdir)/'`./src/apps/parser.cpp

./src/apps/parser-parser.obj: ./src/apps/parser.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(parser_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/parser-parser.obj -MD -MP -MF ./src/apps/$(DEPDIR)/parser-parser.Tpo -c -o ./src/apps/parser-parser.obj `if test -f './src/apps/parser.cpp'; then $(CYGPATH_W) './src/apps/parser.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/parser.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/parser-parser.Tpo ./src/apps/$(DEPDIR)/parser-parser.Po
#	$(AM_V_CXX)source='./src/apps/parser.cpp' object='./src/apps/parser-parser.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(parser_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/parser-parser.obj `if test -f './src/apps/parser.cpp'; then $(CYGPATH_W) './src/apps/parser.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/parser.cpp'; fi`

./src/apps/postProcParam-postProcParam.o: ./src/apps/postProcParam.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(postProcParam_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/postProcParam-postProcParam.o -MD -MP -MF ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Tpo -c -o ./src/apps/postProcParam-postProcParam.o `test -f './src/apps/postProcParam.cpp' || echo '$(srcdir)/'`./src/apps/postProcParam.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Tpo ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Po
#	$(AM_V_CXX)source='./src/apps/postProcParam.cpp' object='./src/apps/postProcParam-postProcParam.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(postProcParam_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/postProcParam-postProcParam.o `test -f './src/apps/postProcParam.cpp' || echo '$(srcdir)/'`./src/apps/postProcParam.cpp

./src/apps/postProcParam-postProcParam.obj: ./src/apps/postProcParam.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(postProcParam_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/postProcParam-postProcParam.obj -MD -MP -MF ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Tpo -c -o ./src/apps/postProcParam-postProcParam.obj `if test -f './src/apps/postProcParam.cpp'; then $(CYGPATH_W) './src/apps/postProcParam.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/postProcParam.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Tpo ./src/apps/$(DEPDIR)/postProcParam-postProcParam.Po
#	$(AM_V_CXX)source='./src/apps/postProcParam.cpp' object='./src/apps/postProcParam-postProcParam.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(postProcParam_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/postProcParam-postProcParam.obj `if test -f './src/apps/postProcParam.cpp'; then $(CYGPATH_W) './src/apps/postProcParam.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/postProcParam.cpp'; fi`

./src/apps/sdsf-sdsf.o: ./src/apps/sdsf.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(sdsf_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/sdsf-sdsf.o -MD -MP -MF ./src/apps/$(DEPDIR)/sdsf-sdsf.Tpo -c -o ./src/apps/sdsf-sdsf.o `test -f './src/apps/sdsf.cpp' || echo '$(srcdir)/'`./src/apps/sdsf.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/sdsf-sdsf.Tpo ./src/apps/$(DEPDIR)/sdsf-sdsf.Po
#	$(AM_V_CXX)source='./src/apps/sdsf.cpp' object='./src/apps/sdsf-sdsf.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(sdsf_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/sdsf-sdsf.o `test -f './src/apps/sdsf.cpp' || echo '$(srcdir)/'`./src/apps/sdsf.cpp

./src/apps/sdsf-sdsf.obj: ./src/apps/sdsf.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(sdsf_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/sdsf-sdsf.obj -MD -MP -MF ./src/apps/$(DEPDIR)/sdsf-sdsf.Tpo -c -o ./src/apps/sdsf-sdsf.obj `if test -f './src/apps/sdsf.cpp'; then $(CYGPATH_W) './src/apps/sdsf.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/sdsf.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/sdsf-sdsf.Tpo ./src/apps/$(DEPDIR)/sdsf-sdsf.Po
#	$(AM_V_CXX)source='./src/apps/sdsf.cpp' object='./src/apps/sdsf-sdsf.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(sdsf_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/sdsf-sdsf.obj `if test -f './src/apps/sdsf.cpp'; then $(CYGPATH_W) './src/apps/sdsf.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/sdsf.cpp'; fi`

./src/apps/yggdrasil-exabayes.o: ./src/apps/exabayes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(yggdrasil_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/yggdrasil-exabayes.o -MD -MP -MF ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Tpo -c -o ./src/apps/yggdrasil-exabayes.o `test -f './src/apps/exabayes.cpp' || echo '$(srcdir)/'`./src/apps/exabayes.cpp
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Tpo ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Po
#	$(AM_V_CXX)source='./src/apps/exabayes.cpp' object='./src/apps/yggdrasil-exabayes.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(yggdrasil_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/yggdrasil-exabayes.o `test -f './src/apps/exabayes.cpp' || echo '$(srcdir)/'`./src/apps/exabayes.cpp

./src/apps/yggdrasil-exabayes.obj: ./src/apps/exabayes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(yggdrasil_CXXFLAGS) $(CXXFLAGS) -MT ./src/apps/yggdrasil-exabayes.obj -MD -MP -MF ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Tpo -c -o ./src/apps/yggdrasil-exabayes.obj `if test -f './src/apps/exabayes.cpp'; then $(CYGPATH_W) './src/apps/exabayes.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/exabayes.cpp'; fi`
	$(AM_V_at)$(am__mv) ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Tpo ./src/apps/$(DEPDIR)/yggdrasil-exabayes.Po
#	$(AM_V_CXX)source='./src/apps/exabayes.cpp' object='./src/apps/yggdrasil-exabayes.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(yggdrasil_CXXFLAGS) $(CXXFLAGS) -c -o ./src/apps/yggdrasil-exabayes.obj `if test -f './src/apps/exabayes.cpp'; then $(CYGPATH_W) './src/apps/exabayes.cpp'; else $(CYGPATH_W) '$(srcdir)/./src/apps/exabayes.cpp'; fi`
...
distclean-generic:
	...
	-rm -f lib/lcfit/lcfit_src/$(DEPDIR)/$(am__dirstamp)
	-rm -f lib/lcfit/lcfit_src/$(am__dirstamp)
	-rm -f lib/ncl-2.1.18/ncl/$(DEPDIR)/$(am__dirstamp)
	-rm -f lib/ncl-2.1.18/ncl/$(am__dirstamp)
	-rm -f lib/pll/$(DEPDIR)/$(am__dirstamp)
	-rm -f lib/pll/$(am__dirstamp)
	-rm -f src/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/$(am__dirstamp)
	-rm -f src/apps/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/apps/$(am__dirstamp)
	-rm -f src/comm/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/comm/$(am__dirstamp)
	-rm -f src/comm/dummy/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/comm/dummy/$(am__dirstamp)
	-rm -f src/comm/mpi/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/comm/mpi/$(am__dirstamp)
	-rm -f src/comm/threads/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/comm/threads/$(am__dirstamp)
	...
	-rm -f src/data-struct/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/data-struct/$(am__dirstamp)
	-rm -f src/eval/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/eval/$(am__dirstamp)
	-rm -f src/file/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/file/$(am__dirstamp)
	-rm -f src/math/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/math/$(am__dirstamp)
	-rm -f src/mcmc/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/mcmc/$(am__dirstamp)
	-rm -f src/model/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/model/$(am__dirstamp)
	-rm -f src/parameters/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/parameters/$(am__dirstamp)
	-rm -f src/parser/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/parser/$(am__dirstamp)
	-rm -f src/priors/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/priors/$(am__dirstamp)
	-rm -f src/proposals/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/proposals/$(am__dirstamp)
	-rm -f src/proposers/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/proposers/$(am__dirstamp)
	-rm -f src/system/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/system/$(am__dirstamp)
	-rm -f src/tree-parse/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/tree-parse/$(am__dirstamp)
...
distclean: distclean-am
	...
	-rm -rf ./lib/lcfit/lcfit_src/$(DEPDIR) ./lib/ncl-2.1.18/ncl/$(DEPDIR) ./lib/pll/$(DEPDIR) ./src/$(DEPDIR) ./src/apps/$(DEPDIR) ./src/comm/$(DEPDIR) ./src/comm/dummy/$(DEPDIR) ./src/comm/mpi/$(DEPDIR) ./src/comm/threads/$(DEPDIR) ./src/config/$(DEPDIR) ./src/contrib/$(DEPDIR) ./src/data-struct/$(DEPDIR) ./src/eval/$(DEPDIR) ./src/file/$(DEPDIR) ./src/math/$(DEPDIR) ./src/mcmc/$(DEPDIR) ./src/model/$(DEPDIR) ./src/parameters/$(DEPDIR) ./src/parser/$(DEPDIR) ./src/priors/$(DEPDIR) ./src/proposals/$(DEPDIR) ./src/proposers/$(DEPDIR) ./src/system/$(DEPDIR) ./src/tree-parse/$(DEPDIR) ./tests/$(DEPDIR)
	-rm -f Makefile
